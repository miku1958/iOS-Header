...
@property (strong, nonatomic) VSIdentityProvider *currentIdentityProvider; // @synthesize currentIdentityProvider=_currentIdentityProvider;
...
@property (strong, nonatomic) VSSetTopBoxProfile *stbProfile; // @synthesize stbProfile=_stbProfile;
