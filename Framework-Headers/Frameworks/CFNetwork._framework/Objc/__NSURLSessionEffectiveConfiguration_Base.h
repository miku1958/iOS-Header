...
@property (readonly, strong) NSHTTPCookieStorage *HTTPCookieStorage; // @dynamic HTTPCookieStorage;
@property (readonly, strong) NSURLCache *URLCache; // @dynamic URLCache;
@property (readonly, strong) NSURLCredentialStorage *URLCredentialStorage; // @dynamic URLCredentialStorage;
