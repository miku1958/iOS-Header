...
@property (strong) NSHTTPCookieStorage *HTTPCookieStorage; // @dynamic HTTPCookieStorage;
...
@property (strong) NSHTTPCookieStorage *_phskip_cookieStorage; // @dynamic _phskip_cookieStorage;
@property BOOL _phskip_cookieStorageSet; // @dynamic _phskip_cookieStorageSet;
@property (strong) NSURLCredentialStorage *_phskip_credStorage; // @dynamic _phskip_credStorage;
@property BOOL _phskip_credStorageSet; // @dynamic _phskip_credStorageSet;
@property (strong) struct _CFHSTSPolicy *_phskip_hstsStorage; // @dynamic _phskip_hstsStorage;
