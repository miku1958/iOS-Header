...
@property (strong) NSObject<OS_nw_activity> *_nw_activity; // @dynamic _nw_activity;
...
@property (strong) NSObject<OS_nw_activity> *_private_nw_activity; // @dynamic _private_nw_activity;
...
@property (strong) __NSCFTaskPerformanceTiming *_taskPerformanceTiming; // @dynamic _taskPerformanceTiming;
