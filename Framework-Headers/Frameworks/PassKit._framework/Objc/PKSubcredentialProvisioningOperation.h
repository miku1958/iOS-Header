...
@property (readonly, nonatomic) BOOL canBeRestarted; // @synthesize canBeRestarted=_canBeRestarted;
@property (readonly, nonatomic) BOOL canCancelOperation; // @synthesize canCancelOperation=_canCancelOperation;
...
@property (readonly, weak, nonatomic) id<PKSubcredentialProvisioningOperationDelegate> delegate; // @synthesize delegate=_delegate;
