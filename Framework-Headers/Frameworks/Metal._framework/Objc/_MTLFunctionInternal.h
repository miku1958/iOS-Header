...
- (void)newSpecializedFunctionWithRequestType:(int)arg1 llvmTargetVersion:(unsigned int)arg2 constants:(id)arg3 functionCache:(id)arg4 originalRequest:(const struct MTLCompilerFunctionRequest *)arg5 sync:(BOOL)arg6 specializedName:(id)arg7 completionHandler:(CDUnknownBlockType)arg8;
...
- (BOOL)specializedFunctionHash:(CDStruct_41a22ec7 *)arg1 requestData:(id *)arg2 constants:(id)arg3 specializedName:(id)arg4 completionHandler:(CDUnknownBlockType)arg5;
