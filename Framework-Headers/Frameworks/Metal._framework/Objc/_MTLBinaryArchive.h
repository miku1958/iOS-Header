...
+ (BOOL)deserializeBinaryArchiveDescriptorMachO:(CDStruct_8c76fc6d *)arg1 fileData:(id)arg2;
+ (BOOL)deserializeBinaryArchiveHeader:(CDStruct_8c76fc6d *)arg1 fileData:(id)arg2 device:(id)arg3;
- (id).cxx_construct;
- (void).cxx_destruct;
