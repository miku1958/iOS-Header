...
- (void)compileFunction:(id)arg1 serializedPipelineData:(id)arg2 stateData:(id)arg3 linkDataSize:(unsigned long long)arg4 frameworkLinking:(BOOL)arg5 options:(unsigned int)arg6 pipelineCache:(id)arg7 sync:(BOOL)arg8 completionHandler:(CDUnknownBlockType)arg9;
...
- (void)compileFunction:(id)arg1 visibleFunctions:(id)arg2 privateVisibleFunctions:(id)arg3 visibleFunctionGroups:(id)arg4 frameworkData:(id)arg5 driverKeyData:(id)arg6 options:(unsigned long long)arg7 pipelineCache:(id)arg8 sync:(BOOL)arg9 completionHandler:(CDUnknownBlockType)arg10;
- (void)compileFunction:(id)arg1 visibleFunctions:(id)arg2 visibleFunctionGroups:(id)arg3 frameworkData:(id)arg4 driverKeyData:(id)arg5 options:(unsigned long long)arg6 pipelineCache:(id)arg7 sync:(BOOL)arg8 completionHandler:(CDUnknownBlockType)arg9;
- (void)compileFunctionRequest:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;
- (void)compileFunctionRequestInternal:(id)arg1 frameworkLinking:(BOOL)arg2 linkDataSize:(unsigned long long)arg3 reflectionOnly:(BOOL)arg4 completionHandler:(CDUnknownBlockType)arg5;
...
- (void)dealloc;
- (struct MTLProgramObject *)getProgramObject:(id)arg1 destinationArchive:(id)arg2 sourceBinaryArchives:(id)arg3 variantKey:(const struct VariantKey *)arg4 requiredBinaryKeys:(const vector_78402f50 *)arg5 failOnMiss:(BOOL)arg6;
...
- (void)reflectionWithFunction:(id)arg1 options:(unsigned long long)arg2 sync:(BOOL)arg3 binaryArchives:(id)arg4 completionHandler:(CDUnknownBlockType)arg5;
...
- (void)reflectionWithFunction:(id)arg1 options:(unsigned long long)arg2 sync:(BOOL)arg3 pipelineLibrary:(id)arg4 binaryArchives:(id)arg5 completionHandler:(CDUnknownBlockType)arg6;
...
- (void)statelessBackendCompileRequestInternal:(struct MTLCompilerFunctionRequest *)arg1 sync:(BOOL)arg2 compilerHash:(const CDStruct_41a22ec7 *)arg3 completionHandler:(CDUnknownBlockType)arg4;
