...
@property (weak, nonatomic) id<NEIKEv2ListenerDelegate> delegate; // @synthesize delegate=_delegate;
...
@property (strong, nonatomic) NSString *kernelSASessionName; // @synthesize kernelSASessionName=_kernelSASessionName;
@property (strong, nonatomic) NSObject<OS_nw_listener> *listener; // @synthesize listener=_listener;
@property (strong, nonatomic) NSObject<OS_dispatch_queue> *listenerQueue; // @synthesize listenerQueue=_listenerQueue;
@property (weak, nonatomic) id<NEIKEv2PacketDelegate> packetDelegate; // @synthesize packetDelegate=_packetDelegate;
@property (strong, nonatomic) NEIPSecSASession *saSession; // @synthesize saSession=_saSession;
@property (strong, nonatomic) NSMutableArray *sessionsBeforeAuth; // @synthesize sessionsBeforeAuth=_sessionsBeforeAuth;
@property (readonly) Class superclass;
@property (strong, nonatomic) NEIKEv2Transport *transport; // @synthesize transport=_transport;
