...
@property (nonatomic) BOOL hasOutboundRequestInFlight; // @synthesize hasOutboundRequestInFlight=_hasOutboundRequestInFlight;
...
@property (strong, nonatomic) NSMutableArray *pendingRequestContexts; // @synthesize pendingRequestContexts=_pendingRequestContexts;
...
- (int)sendRequest:(id)arg1 retryIntervalInMilliseconds:(unsigned long long)arg2 maxRetries:(unsigned int)arg3 timeoutError:(id)arg4 resend:(BOOL)arg5 sendMessageID:(int)arg6 sendCompletionHandler:(CDUnknownBlockType)arg7 replyHandler:(CDUnknownBlockType)arg8;
