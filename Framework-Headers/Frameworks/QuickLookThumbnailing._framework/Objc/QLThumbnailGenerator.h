...
@property (strong, nonatomic) NSMutableDictionary *pendingCancelledRequests; // @synthesize pendingCancelledRequests=_pendingCancelledRequests;
@property (strong, nonatomic) NSMutableDictionary *pendingGenerationRequests; // @synthesize pendingGenerationRequests=_pendingGenerationRequests;
@property (strong, nonatomic) NSMutableDictionary *preparingGenerationRequests; // @synthesize preparingGenerationRequests=_preparingGenerationRequests;
...
@property (strong, nonatomic) QLThumbnailServiceProxy *syncThumbnailServiceProxy; // @synthesize syncThumbnailServiceProxy=_syncThumbnailServiceProxy;
@property (strong, nonatomic) QLThumbnailServiceProxy *thumbnailServiceProxy; // @synthesize thumbnailServiceProxy=_thumbnailServiceProxy;
