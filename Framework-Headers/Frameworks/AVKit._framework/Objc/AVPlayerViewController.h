...
@property (readonly, nonatomic) UIWindow *_fullScreenWindow;
@property (strong, nonatomic, setter=_setFullScreenWindow:) AVWindow *_fullScreenWindow; // @synthesize _fullScreenWindow=__fullScreenWindow;
