...
@property (strong, nonatomic) GCDeviceBattery *battery; // @synthesize battery=_battery;
@property (readonly, copy) NSString *debugDescription;
@property (weak, nonatomic) id<GCBatteryXPCProxyServerEndpointDelegate> delegate; // @synthesize delegate=_delegate;
