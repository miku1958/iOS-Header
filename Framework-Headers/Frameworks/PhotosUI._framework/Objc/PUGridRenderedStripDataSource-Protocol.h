...
- (void)renderedStrip:(PUGridRenderedStrip *)arg1 enumerateAssetsForVisualSection:(long long)arg2 inVisualItemRange:(struct _NSRange)arg3 usingBlock:(void (^)(long long, PHAsset *, BOOL *))arg4;
