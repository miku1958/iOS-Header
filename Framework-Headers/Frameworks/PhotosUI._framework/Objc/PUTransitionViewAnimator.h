...
@property (strong, nonatomic, setter=_setAutoUpdateDisplayLink:) CADisplayLink *_autoUpdateDisplayLink; // @synthesize _autoUpdateDisplayLink=__autoUpdateDisplayLink;
...
@property (strong, nonatomic, setter=_setProgressFilter:) PUValueFilter *_progressFilter; // @synthesize _progressFilter=__progressFilter;
@property (strong, nonatomic, setter=_setRampUpFilter:) PUValueFilter *_rampUpFilter; // @synthesize _rampUpFilter=__rampUpFilter;
@property (strong, nonatomic, setter=_setShouldFinishFilter:) PUValueFilter *_shouldFinishFilter; // @synthesize _shouldFinishFilter=__shouldFinishFilter;
...
@property (weak, nonatomic) id<PUTransitionViewAnimatorDelegate> delegate; // @synthesize delegate=_delegate;
