...
@property (strong, nonatomic, setter=_setComposition:) PXTilingControllerComposition *_composition; // @synthesize _composition=__composition;
...
@property (readonly, weak, nonatomic) id<PXTilingScrollController> _scrollController; // @synthesize _scrollController=__scrollController;
