...
@property (nonatomic, getter=_isInteracting, setter=_setInteracting:) BOOL _interacting; // @synthesize _interacting=__interacting;
...
@property (strong, nonatomic, setter=_setRetargetBehavior:) _UIFeedbackRetargetBehavior *_retargetBehavior; // @synthesize _retargetBehavior=__retargetBehavior;
