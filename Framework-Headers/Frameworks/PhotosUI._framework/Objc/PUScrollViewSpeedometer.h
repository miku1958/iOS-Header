...
@property (weak, nonatomic, setter=_setLastScrollView:) UIScrollView *_lastScrollView; // @synthesize _lastScrollView=__lastScrollView;
...
@property (weak, nonatomic) id<PUScrollViewSpeedometerDelegate> delegate; // @synthesize delegate=_delegate;
