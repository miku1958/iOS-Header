...
@property (strong, nonatomic) PXLabeledValue *conjunctionValue; // @synthesize conjunctionValue=_conjunctionValue;
@property (readonly, nonatomic) NSArray *conjunctionValues; // @synthesize conjunctionValues=_conjunctionValues;
@property (readonly, copy) NSString *debugDescription;
@property (weak, nonatomic) id<PXSmartAlbumQueryDelegate> delegate; // @synthesize delegate=_delegate;
