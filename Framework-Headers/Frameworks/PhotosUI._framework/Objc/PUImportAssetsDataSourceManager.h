...
@property (weak, nonatomic) id<PUImportAssetsDataSourceManagerDelegate> delegate; // @synthesize delegate=_delegate;
...
@property (strong, nonatomic) PUImportAssetsDataSource *unfilteredDataSource; // @synthesize unfilteredDataSource=_unfilteredDataSource;
