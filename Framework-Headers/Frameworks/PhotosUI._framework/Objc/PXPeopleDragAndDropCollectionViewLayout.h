...
@property (strong, nonatomic) NSIndexPath *dragIndexPathForMerge; // @synthesize dragIndexPathForMerge=_dragIndexPathForMerge;
@property (strong, nonatomic) NSTimer *dragPauseTimer; // @synthesize dragPauseTimer=_dragPauseTimer;
...
@property (strong, nonatomic) NSIndexPath *targetIndexPathForMerge; // @synthesize targetIndexPathForMerge=_targetIndexPathForMerge;
