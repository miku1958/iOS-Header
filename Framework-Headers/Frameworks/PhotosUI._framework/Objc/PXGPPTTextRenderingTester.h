...
@property (strong, nonatomic) PXGStringTextureProvider *stringTextureProvider; // @synthesize stringTextureProvider=_stringTextureProvider;
@property (strong, nonatomic) PXGPPTStringsLayout *stringsLayout; // @synthesize stringsLayout=_stringsLayout;
