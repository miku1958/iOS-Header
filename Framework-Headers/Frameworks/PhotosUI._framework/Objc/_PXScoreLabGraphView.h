...
@property (strong) NSPredicate *assetPredicate; // @synthesize assetPredicate=_assetPredicate;
@property (weak) id<_PXScoreLabGraphViewDelegate> delegate; // @synthesize delegate=_delegate;
