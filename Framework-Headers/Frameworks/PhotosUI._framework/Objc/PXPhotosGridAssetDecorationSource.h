...
@property (nonatomic) BOOL hidesInteractiveFavoriteBadges; // @synthesize hidesInteractiveFavoriteBadges=_hidesInteractiveFavoriteBadges;
...
@property (nonatomic, getter=isSelectionLimitReached) BOOL selectionLimitReached; // @synthesize selectionLimitReached=_selectionLimitReached;
