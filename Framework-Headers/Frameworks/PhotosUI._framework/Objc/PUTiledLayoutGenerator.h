...
- (BOOL)scanAnyTile:(struct PUTileInfo *)arg1;
- (BOOL)scanTile:(struct PUTileInfo *)arg1 ofType:(long long)arg2;
- (BOOL)scanTile:(struct PUTileInfo *)arg1 passingTest:(CDUnknownBlockType)arg2;
- (BOOL)scanTile:(struct PUTileInfo *)arg1 type:(long long *)arg2;
- (BOOL)scanTileWithHorizontalPanorama:(struct PUTileInfo *)arg1;
- (BOOL)scanTileWithLandscapeImage:(struct PUTileInfo *)arg1;
- (BOOL)scanTileWithPortraitImage:(struct PUTileInfo *)arg1;
- (BOOL)scanTileWithSquareImage:(struct PUTileInfo *)arg1;
