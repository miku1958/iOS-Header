...
@property (readonly, nonatomic) BOOL isAggregation; // @synthesize isAggregation;
@property (readonly, nonatomic) BOOL isEnriched; // @synthesize isEnriched;
@property (readonly, nonatomic) BOOL isEnrichmentComplete; // @synthesize isEnrichmentComplete;
@property (readonly, nonatomic) BOOL isRecent; // @synthesize isRecent;
...
@property (readonly, nonatomic) BOOL px_isSuggestion; // @synthesize px_isSuggestion;
