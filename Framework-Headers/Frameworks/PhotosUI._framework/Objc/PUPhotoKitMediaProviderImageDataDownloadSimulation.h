...
@property (strong, nonatomic, setter=_setResultDataUTI:) NSString *_resultDataUTI; // @synthesize _resultDataUTI=__resultDataUTI;
@property (strong, nonatomic, setter=_setResultImageData:) NSData *_resultImageData; // @synthesize _resultImageData=__resultImageData;
