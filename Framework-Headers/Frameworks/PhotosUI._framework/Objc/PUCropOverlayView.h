...
@property (strong, nonatomic) PUCropMaskView *bottomMask; // @synthesize bottomMask=_bottomMask;
...
@property (strong, nonatomic) PUCropMaskView *leftMask; // @synthesize leftMask=_leftMask;
...
@property (strong, nonatomic) PUCropMaskView *rightMask; // @synthesize rightMask=_rightMask;
...
@property (strong, nonatomic) PUCropMaskView *topMask; // @synthesize topMask=_topMask;
