...
@property (weak, nonatomic) id<PXCMMViewControllerDelegate> delegate; // @synthesize delegate=_delegate;
...
@property (strong, nonatomic) UINavigationBar *standaloneNavigationBar; // @synthesize standaloneNavigationBar=_standaloneNavigationBar;
