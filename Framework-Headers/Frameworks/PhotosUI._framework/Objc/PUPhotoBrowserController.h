...
@property (strong, nonatomic, setter=_setLockScreenSharingObserver:) id _lockScreenSharingObserver; // @synthesize _lockScreenSharingObserver=__lockScreenSharingObserver;
...
@property (weak, nonatomic) id<PUPhotoBrowserControllerDelegate> delegate; // @synthesize delegate=_delegate;
@property (readonly, copy) NSString *description;
@property (readonly) unsigned long long hash;
@property (strong, nonatomic) PLCloudSharedComment *initialComment; // @synthesize initialComment=_initialComment;
...
- (BOOL)ppt_scrollToPhotoWithRelativeIndex:(long long)arg1 completion:(CDUnknownBlockType)arg2;
