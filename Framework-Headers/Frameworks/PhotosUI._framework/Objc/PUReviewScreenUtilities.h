...
+ (struct CGRect)cameraContentFrameForContentAspectRatio:(double)arg1 referenceBounds:(struct CGRect)arg2 shouldShiftPreviewForUtilityBar:(BOOL)arg3;
...
+ (CDStruct_d54ccef3)cameraContentGeometryForReferenceBounds:(struct CGRect)arg1 forContentSize:(struct CGSize)arg2 withOrientation:(long long)arg3 shouldShiftPreviewForUtilityBar:(BOOL)arg4;
