...
@property (nonatomic) BOOL allowSafeAreaChangeAnchor; // @synthesize allowSafeAreaChangeAnchor=_allowSafeAreaChangeAnchor;
...
@property (readonly, weak, nonatomic) id<PUAssetPickerContainerControllerActionHandler> containerControllerActionHandler; // @synthesize containerControllerActionHandler=_containerControllerActionHandler;
...
@property (strong, nonatomic) PXGAnchor *pinToTopAnchor; // @synthesize pinToTopAnchor=_pinToTopAnchor;
