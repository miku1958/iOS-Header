...
- (void)_dismiss;
- (void)dealloc;
- (id)initWithPrompt:(id)arg1 forUserNamesOnly:(BOOL)arg2 appNames:(id)arg3 appID:(id)arg4 matchedSites:(id)arg5 urlString:(id)arg6 minimumNumberOfCredentialsToShowLikelyMatchesSection:(unsigned long long)arg7 shouldShowIcons:(BOOL)arg8 shouldGetHintStrings:(BOOL)arg9 completionHandler:(CDUnknownBlockType)arg10;
