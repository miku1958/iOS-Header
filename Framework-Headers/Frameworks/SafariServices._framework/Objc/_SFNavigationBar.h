...
@property (nonatomic) BOOL usesFaintSeparator; // @synthesize usesFaintSeparator=_usesFaintSeparator;
...
- (void)layoutSubviews;
- (BOOL)navigationBarURLButton:(id)arg1 canWriteAtLocation:(struct CGPoint)arg2;
...
- (void)setExpanded:(BOOL)arg1 completionHandler:(CDUnknownBlockType)arg2;
- (void)setExpanded:(BOOL)arg1 textFieldSelectionRange:(struct _NSRange)arg2;
- (void)setExpanded:(BOOL)arg1 textFieldSelectionRange:(struct _NSRange)arg2 completionHandler:(CDUnknownBlockType)arg3;
