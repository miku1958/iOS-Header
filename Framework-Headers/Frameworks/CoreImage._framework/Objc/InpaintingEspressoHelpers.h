...
+ (BOOL)bindEspressoInputBufferForInputName:(id)arg1 buffer:(struct vImage_Buffer)arg2 preprocessingParams:(CDStruct_18e74ac9)arg3 network:(CDStruct_2bc666a5)arg4 noAlphaPremultiply:(BOOL)arg5 error:(id *)arg6;
