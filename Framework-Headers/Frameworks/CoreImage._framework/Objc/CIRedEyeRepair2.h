...
+ (void)drawBitmask:(CDStruct_94ca5ecd *)arg1 withOval:(CDStruct_7a4a8b82 *)arg2 index:(int)arg3 comparison:(BOOL)arg4 salientMode:(int)arg5 debugComments:(CDStruct_1c6f3adb *)arg6;
...
- (CDStruct_94ca5ecd *)localComputeBitmaskWithChannel:(CDStruct_c3faddef *)arg1 x:(int)arg2 y:(int)arg3 options:(CDStruct_e5fcc3f9 *)arg4 eyeCase:(int)arg5 returningMaxData:(CDStruct_32eeb3fa *)arg6 isSpecularData:(BOOL *)arg7 maxSpecularData:(CDStruct_32eeb3fa *)arg8 specularBitmask:(CDStruct_183601bc **)arg9;
- (id)mutableCopyOfArray:(id)arg1;
- (BOOL)needsEyelidOcclusionWithBase:(char *)arg1 side:(int)arg2 upper:(int)arg3;
- (id)packGlobalRepairDictionary:(CDStruct_9d808415 *)arg1 print:(BOOL)arg2;
- (id)packRepairDictionary:(CDStruct_9d808415 *)arg1;
- (id)packRepairDictionary:(CDStruct_9d808415 *)arg1 print:(BOOL)arg2;
