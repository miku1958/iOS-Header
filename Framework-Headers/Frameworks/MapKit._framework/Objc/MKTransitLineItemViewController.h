...
@property (strong, nonatomic) NSNumber *favorited; // @synthesize favorited=_favorited;
@property (readonly) unsigned long long hash;
@property (readonly, nonatomic, getter=isLoading) BOOL loading; // @synthesize loading=_loading;
@property (strong, nonatomic) MKPlaceCardActionItem *removeFromFavoritesItem; // @synthesize removeFromFavoritesItem=_removeFromFavoritesItem;
