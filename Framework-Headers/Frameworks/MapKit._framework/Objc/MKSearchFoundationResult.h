...
@property (strong, nonatomic) MKSearchFoundationBusinessHoursAndDistanceRichText *thirdLineDisplayedText; // @synthesize thirdLineDisplayedText=_thirdLineDisplayedText;
@property (strong, nonatomic) NSMutableArray *thirdLineText; // @synthesize thirdLineText=_thirdLineText;
