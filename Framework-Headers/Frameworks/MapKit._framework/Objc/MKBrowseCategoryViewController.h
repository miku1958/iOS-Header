...
@property (strong, nonatomic) MKBrowseCategoryCollectionView *collectionView; // @synthesize collectionView=_collectionView;
...
@property (weak, nonatomic) id<MKBrowseCategoryViewControllerDelegate> delegate; // @synthesize delegate=_delegate;
