...
@property (readonly, nonatomic) BOOL isStickerProvider;
...
@property (strong, nonatomic) LSApplicationProxy *privateDocumentTypeOwner; // @synthesize privateDocumentTypeOwner=_privateDocumentTypeOwner;
