...
@property (strong, nonatomic) NSHashTable *availabilityObservers; // @synthesize availabilityObservers=_availabilityObservers;
...
@property (readonly) unsigned long long hash;
@property (strong, nonatomic) PAImageConversionServiceClient *imageConversionServiceClient; // @synthesize imageConversionServiceClient=_imageConversionServiceClient;
...
@property (strong, nonatomic) PHPerformChangesRequest *performChangesRequest; // @synthesize performChangesRequest=_performChangesRequest;
...
@property (strong) NSError *unavailabilityReason; // @synthesize unavailabilityReason=_unavailabilityReason;
...
@property (strong, nonatomic) PAVideoConversionServiceClient *videoConversionServiceClient; // @synthesize videoConversionServiceClient=_videoConversionServiceClient;
...
+ (void)_requestAuthorizationForAccessLevel:(long long)arg1 supportsLimited:(BOOL)arg2 handler:(CDUnknownBlockType)arg3;
