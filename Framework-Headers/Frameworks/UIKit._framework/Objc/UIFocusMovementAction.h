...
- (id)initWithFocusMovementInfo:(id)arg1 inputDeviceInfo:(id)arg2 shouldPerformHapticFeedback:(BOOL)arg3 focusedFrameInSceneCoordinateSpace:(struct CGRect)arg4;
