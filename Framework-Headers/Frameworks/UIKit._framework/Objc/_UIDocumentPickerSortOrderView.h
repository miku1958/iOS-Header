...
@property (strong, nonatomic) UIButton *listModeToggle; // @synthesize listModeToggle=_listModeToggle;
...
@property (strong, nonatomic) UISegmentedControl *sortOrder; // @synthesize sortOrder=_sortOrder;
