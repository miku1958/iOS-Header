...
@property (strong, nonatomic, setter=_setDeferredOrientationUpdate:) _UIWindowOrientationUpdate *_deferredOrientationUpdate; // @synthesize _deferredOrientationUpdate;
...
@property (strong, nonatomic, getter=_rootPresentationController, setter=_setRootPresentationController:) _UIRootPresentationController *rootPresentationController; // @synthesize rootPresentationController=_rootPresentationController;
...
- (struct CGRect)_referenceFrameFromSceneUsingScreenBounds:(BOOL)arg1;
