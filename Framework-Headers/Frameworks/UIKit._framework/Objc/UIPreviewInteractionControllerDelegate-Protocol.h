...
- (BOOL)previewInteractionController:(UIPreviewInteractionController *)arg1 shouldUseStandardRevealTransformForPreviewingAtPosition:(struct CGPoint)arg2 inView:(UIView *)arg3;
