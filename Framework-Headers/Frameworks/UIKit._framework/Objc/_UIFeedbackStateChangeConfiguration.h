...
@property (strong, nonatomic) _UIFeedback<_UIFeedbackContinuousPlayable> *approachFeedback; // @synthesize approachFeedback=_approachFeedback;
...
@property (strong, nonatomic) _UIFeedback<_UIFeedbackDiscretePlayable> *thresholdFeedback; // @synthesize thresholdFeedback=_thresholdFeedback;
