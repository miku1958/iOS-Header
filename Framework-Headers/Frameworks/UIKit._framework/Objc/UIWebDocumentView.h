...
@property (strong, nonatomic) NSString *draggedLinkTitle; // @synthesize draggedLinkTitle=_draggedLinkTitle;
@property (strong, nonatomic) NSURL *draggedLinkURL; // @synthesize draggedLinkURL=_draggedLinkURL;
