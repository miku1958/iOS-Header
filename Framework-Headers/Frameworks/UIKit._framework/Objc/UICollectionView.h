...
@property (strong, nonatomic, getter=_reorderDestinationView, setter=_setReorderDestinationView:) _UIDragDestinationIndicatorView *reorderDestinationView; // @synthesize reorderDestinationView=_reorderDestinationView;
...
- (void)_performBatchUpdates:(CDUnknownBlockType)arg1 completion:(CDUnknownBlockType)arg2 invalidationContext:(id)arg3 tentativelyForReordering:(BOOL)arg4 animator:(id)arg5 animationHandler:(CDUnknownBlockType)arg6;
