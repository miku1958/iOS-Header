...
@property (nonatomic) BOOL privHasMetadata; // @synthesize privHasMetadata=_privHasMetadata;
@property (nonatomic) BOOL privHasThumbnail; // @synthesize privHasThumbnail=_privHasThumbnail;
...
@property (readonly, nonatomic) BOOL retrievedMetadata; // @synthesize retrievedMetadata=_retrievedMetadata;
@property (readonly, nonatomic) BOOL retrievedThumbnail; // @synthesize retrievedThumbnail=_retrievedThumbnail;
