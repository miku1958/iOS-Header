...
@property (strong, nonatomic) ARImageData *imageDataForNeuralNetwork; // @synthesize imageDataForNeuralNetwork=_imageDataForNeuralNetwork;
@property (strong, nonatomic) ARImageData *inputImageData; // @synthesize inputImageData=_inputImageData;
