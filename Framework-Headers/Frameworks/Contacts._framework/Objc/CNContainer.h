...
@property (readonly, nonatomic, getter=isGuardianRestricted) BOOL guardianRestricted; // @synthesize guardianRestricted=_guardianRestricted;
@property (readonly, nonatomic, getter=isGuardianStateDirty) BOOL guardianStateDirty; // @synthesize guardianStateDirty=_guardianStateDirty;
