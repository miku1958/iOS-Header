...
@property (strong, nonatomic) HKQuantity *appleMoveMinutes;
@property (strong, nonatomic) HKQuantity *appleMoveMinutesGoal;
@property (strong, nonatomic) HKQuantity *appleMoveTime;
@property (strong, nonatomic) HKQuantity *appleMoveTimeGoal;
...
@property (strong, nonatomic, getter=_dailyMoveMinutesStatistics, setter=_setDailyMoveMinutesStatistics:) NSArray *dailyMoveMinuteStatistics; // @synthesize dailyMoveMinuteStatistics=_dailyMoveMinuteStatistics;
@property (strong, nonatomic, getter=_dailyMoveTimeStatistics, setter=_setDailyMoveTimeStatistics:) NSArray *dailyMoveTimeStatistics; // @synthesize dailyMoveTimeStatistics=_dailyMoveTimeStatistics;
...
@property (strong, nonatomic, getter=_moveTimeGoalDate, setter=_setMoveTimeGoalDate:) NSDate *moveTimeGoalDate; // @synthesize moveTimeGoalDate=_moveTimeGoalDate;
