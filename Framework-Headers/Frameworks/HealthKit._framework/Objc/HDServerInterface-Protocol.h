...
- (void)_remote_attachDeepBreathingSessionServerWithClient:(id)arg1 sessionConfiguration:(_HKDeepBreathingSessionConfiguration *)arg2 handler:(void (^)(id, BOOL, NSError *))arg3;
...
- (void)remote_discardLocationSeries:(HKLocationSeriesSample *)arg1 completion:(void (^)(BOOL, NSError *))arg2;
...
- (void)remote_saveLocationSeriesData:(NSArray *)arg1 withSeriesSample:(HKLocationSeriesSample *)arg2 completion:(void (^)(BOOL, NSError *))arg3;
