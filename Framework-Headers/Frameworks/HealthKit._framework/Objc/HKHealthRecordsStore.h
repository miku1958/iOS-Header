...
@property (strong) NSHashTable *ingestionStateChangeListeners; // @synthesize ingestionStateChangeListeners=_ingestionStateChangeListeners;
...
- (void)accountWithIdentifier:(struct NSUUID *)arg1 setUserEnabled:(BOOL)arg2 completion:(CDUnknownBlockType)arg3;
