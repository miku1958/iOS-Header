...
- (id)_copyOccurrenceDatesWithEKEvent:(id)arg1 recurrenceRule:(id)arg2 startDate:(CDStruct_79f9e052)arg3 endDate:(CDStruct_79f9e052)arg4 timeZone:(id)arg5 exceptionDates:(id)arg6 limit:(long long)arg7 adjustDatesForAllDayEvents:(BOOL)arg8;
...
- (id)copyOccurrenceDatesWithEKEvent:(id)arg1 recurrenceRule:(id)arg2 startDate:(CDStruct_79f9e052)arg3 endDate:(CDStruct_79f9e052)arg4 timeZone:(id)arg5 limit:(long long)arg6 adjustDatesForAllDayEvents:(BOOL)arg7;
