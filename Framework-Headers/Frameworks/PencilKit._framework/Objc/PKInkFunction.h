...
@property (strong, nonatomic) NSMutableArray *maxOutputPoints; // @synthesize maxOutputPoints=_maxOutputPoints;
@property (strong, nonatomic) NSMutableArray *minOutputPoints; // @synthesize minOutputPoints=_minOutputPoints;
