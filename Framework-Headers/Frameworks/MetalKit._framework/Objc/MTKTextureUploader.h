...
- (void)copyBytes:(const void *)arg1 toTexture:(id)arg2 bitsPerPixel:(unsigned long long)arg3 pixelComponents:(unsigned long long)arg4 bytesPerRow:(unsigned long long)arg5 bytesPerImage:(unsigned long long)arg6 region:(CDStruct_4c83c94d)arg7 slice:(unsigned long long)arg8 level:(unsigned long long)arg9 flipVertically:(BOOL)arg10;
