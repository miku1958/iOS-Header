...
- (void)_elementDidFocus:(const struct FocusedElementInformation *)arg1 userIsInteracting:(BOOL)arg2 blurPreviousNode:(BOOL)arg3 changingActivityState:(BOOL)arg4 userObject:(id)arg5;
