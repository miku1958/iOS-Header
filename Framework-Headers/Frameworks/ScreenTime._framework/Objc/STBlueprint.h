...
@property (strong, nonatomic) STCoreOrganization *organization; // @dynamic organization;
@property (strong, nonatomic) STBlueprintSchedule *schedule; // @dynamic schedule;
@property (readonly) Class superclass;
@property (copy, nonatomic) NSString *type; // @dynamic type;
@property (strong, nonatomic) STBlueprintUsageLimit *usageLimit; // @dynamic usageLimit;
