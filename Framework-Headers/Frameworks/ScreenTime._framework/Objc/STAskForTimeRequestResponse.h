...
@property (strong, nonatomic) STFamilyOrganization *familyOrganization; // @dynamic familyOrganization;
...
@property (strong, nonatomic) STCoreUser *requestingUser; // @dynamic requestingUser;
@property (strong, nonatomic) STCoreUser *respondingUser; // @dynamic respondingUser;
