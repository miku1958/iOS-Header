...
@property (strong, nonatomic) NSString *cachedSendInviteCellReuseIdentifier; // @synthesize cachedSendInviteCellReuseIdentifier=_cachedSendInviteCellReuseIdentifier;
...
@property (strong, nonatomic) NSArray *pendingParticipants; // @synthesize pendingParticipants=_pendingParticipants;
