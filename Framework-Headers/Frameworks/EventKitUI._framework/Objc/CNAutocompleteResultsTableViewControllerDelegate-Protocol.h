...
- (BOOL)autocompleteResultsController:(CNAutocompleteResultsTableViewController *)arg1 willOverrideImageDataForRecipient:(CNComposeRecipient *)arg2 completion:(void (^)(NSData *))arg3;
@end
