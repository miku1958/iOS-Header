...
@property (strong, nonatomic) id<MTLFunction> fragmentFunction; // @synthesize fragmentFunction=_fragmentFunction;
...
@property (strong, nonatomic) id<MTLRenderPipelineState> state; // @synthesize state=_state;
...
@property (strong, nonatomic) id<MTLFunction> vertexFunction; // @synthesize vertexFunction=_vertexFunction;
