...
@property (strong, nonatomic) _INPBDateTimeRange *oldValue; // @synthesize oldValue=_oldValue;
@property (readonly) Class superclass;
@property (strong, nonatomic) _INPBDateTimeRange *updatedValue; // @synthesize updatedValue=_updatedValue;
