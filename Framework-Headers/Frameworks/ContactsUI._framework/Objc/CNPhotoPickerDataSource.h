...
@property (strong, nonatomic) NSArray *emojiSuggestionItems; // @synthesize emojiSuggestionItems=_emojiSuggestionItems;
@property (strong, nonatomic) NSMutableArray *groupIsCollapsedState; // @synthesize groupIsCollapsedState=_groupIsCollapsedState;
