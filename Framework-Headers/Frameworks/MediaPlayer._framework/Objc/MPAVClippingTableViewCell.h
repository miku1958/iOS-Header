...
@property (strong, nonatomic) UIView *clippingContentView; // @synthesize clippingContentView=_clippingContentView;
@property (nonatomic) struct UIEdgeInsets clippingInsets; // @synthesize clippingInsets=_clippingInsets;
@property (strong, nonatomic) UIView *clippingMaskView; // @synthesize clippingMaskView=_clippingMaskView;
