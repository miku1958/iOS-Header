...
@property (strong, nonatomic) NSDictionary *otherAttributes; // @synthesize otherAttributes=_otherAttributes;
...
@property (strong, nonatomic) CLKFont *smallCapsBaseFont; // @synthesize smallCapsBaseFont=_smallCapsBaseFont;
