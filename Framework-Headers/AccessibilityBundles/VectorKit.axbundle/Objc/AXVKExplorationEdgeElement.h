...
@property (strong, nonatomic) VKRoadFeatureAccessibilityElement *road; // @synthesize road=_road;
@property (strong, nonatomic) NSArray *vertices; // @synthesize vertices=_vertices;
