...
- (void)getTextureAccessCounters:(id<MTLTexture>)arg1 region:(CDStruct_4c83c94d)arg2 mipLevel:(unsigned long long)arg3 slice:(unsigned long long)arg4 resetCounters:(BOOL)arg5 countersBuffer:(id<MTLBuffer>)arg6 countersBufferOffset:(unsigned long long)arg7;
