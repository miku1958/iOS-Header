...
@property (strong, nonatomic) EDMailDynamicDataAsset *_mailDynamicData; // @synthesize _mailDynamicData;
@property (weak, nonatomic) id<EMUserProfileProvider> _profileProvider; // @synthesize _profileProvider;
@property (strong, nonatomic) NSString *_recordingKey; // @synthesize _recordingKey;
@property (strong, nonatomic) _MSTTLReference *_userDomains; // @synthesize _userDomains;
