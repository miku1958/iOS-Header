...
@property (weak, nonatomic) id<NMSSHChannelDelegate> delegate; // @synthesize delegate=_delegate;
@property (strong, nonatomic) NSDictionary *environmentVariables; // @synthesize environmentVariables=_environmentVariables;
@property (strong, nonatomic) NSData *lastResponse; // @synthesize lastResponse=_lastResponse;
