...
@property (strong, nonatomic) NSDate *createdAfterDate; // @synthesize createdAfterDate=_createdAfterDate;
@property (strong, nonatomic) NSDate *createdBeforeDate; // @synthesize createdBeforeDate=_createdBeforeDate;
