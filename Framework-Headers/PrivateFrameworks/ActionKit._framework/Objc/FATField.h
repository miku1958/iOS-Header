...
@property (strong, nonatomic) FATField *keyField; // @synthesize keyField=_keyField;
...
@property (strong, nonatomic) FATField *valueField; // @synthesize valueField=_valueField;
