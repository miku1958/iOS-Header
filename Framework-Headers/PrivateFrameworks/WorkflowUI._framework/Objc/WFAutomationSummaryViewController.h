...
@property (strong, nonatomic) NSArray *actionIcons; // @synthesize actionIcons=_actionIcons;
@property (readonly, copy) NSString *debugDescription;
@property (weak, nonatomic) id<WFAutomationSummaryViewControllerDelegate> delegate; // @synthesize delegate=_delegate;
