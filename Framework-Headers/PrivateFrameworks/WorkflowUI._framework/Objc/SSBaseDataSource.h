...
@property (weak, nonatomic) Class cellClass; // @synthesize cellClass=_cellClass;
...
@property (weak, nonatomic) Class collectionViewSupplementaryElementClass; // @synthesize collectionViewSupplementaryElementClass=_collectionViewSupplementaryElementClass;
@property (readonly, copy) NSString *debugDescription;
@property (readonly, copy) NSString *description;
@property (strong, nonatomic) UIView *emptyView; // @synthesize emptyView=_emptyView;
