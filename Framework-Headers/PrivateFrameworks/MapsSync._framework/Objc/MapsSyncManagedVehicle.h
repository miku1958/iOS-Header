...
@property (nonatomic, strong) NSNumber *supportedConnectors; // @dynamic supportedConnectors;
@property (nonatomic, copy) NSString *vehicleIdentifier; // @dynamic vehicleIdentifier;
@property (nonatomic, strong) NSNumber *vehicleType; // @dynamic vehicleType;
@property (nonatomic, strong) NSNumber *year; // @dynamic year;
