...
- (id)initWithName:(id)arg1 originalSize:(CDStruct_e791d03f)arg2 originalPixelFormat:(CDStruct_e791d03f)arg3 destinationPixelFormat:(long long)arg4 downsamplingFactor:(long long)arg5 fileType:(BOOL)arg6 generateMipmaps: /* Error: Ran out of types for this method. */;
