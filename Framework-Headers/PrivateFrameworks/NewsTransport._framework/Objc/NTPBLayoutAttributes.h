...
@property (strong, nonatomic) NSData *accessoryFontColor; // @synthesize accessoryFontColor=_accessoryFontColor;
...
@property (strong, nonatomic) NSData *accessoryIconColor; // @synthesize accessoryIconColor=_accessoryIconColor;
...
@property (strong, nonatomic) NSData *backgroundColor; // @synthesize backgroundColor=_backgroundColor;
...
@property (strong, nonatomic) NSString *decorationKind; // @synthesize decorationKind=_decorationKind;
@property (strong, nonatomic) NSData *excerptColor; // @synthesize excerptColor=_excerptColor;
...
@property (strong, nonatomic) NSData *numberedCircleColor; // @synthesize numberedCircleColor=_numberedCircleColor;
...
@property (strong, nonatomic) NSData *publisherLogoColor; // @synthesize publisherLogoColor=_publisherLogoColor;
