...
@property (strong, nonatomic) NSMutableArray *portraitTagThresholds; // @synthesize portraitTagThresholds=_portraitTagThresholds;
...
@property (strong, nonatomic) NSMutableArray *realTimeUserFeedbackTagCoefficients; // @synthesize realTimeUserFeedbackTagCoefficients=_realTimeUserFeedbackTagCoefficients;
