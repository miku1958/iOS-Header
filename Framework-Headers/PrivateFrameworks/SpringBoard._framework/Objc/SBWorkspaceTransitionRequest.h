...
@property (strong, nonatomic) SBWorkspaceApplicationSceneTransitionContext *applicationContext; // @synthesize applicationContext=_applicationContext;
...
@property (strong, nonatomic) SBWorkspaceTransientOverlayTransitionContext *transientOverlayContext; // @synthesize transientOverlayContext=_transientOverlayContext;
