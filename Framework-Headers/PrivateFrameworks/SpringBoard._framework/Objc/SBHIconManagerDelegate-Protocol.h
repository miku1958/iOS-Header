...
- (void)iconManager:(SBHIconManager *)arg1 launchIcon:(SBIcon *)arg2 location:(NSString *)arg3 animated:(BOOL)arg4 completionHandler:(void (^)(BOOL))arg5;
...
- (void)iconManager:(SBHIconManager *)arg1 prepareForPageHidingEducationWithCompletionHandler:(void (^)(BOOL))arg2;
...
- (id<BSInvalidatable>)iconManager:(SBHIconManager *)arg1 wantsToHideStatusBarForFolderController:(SBFolderController *)arg2 animated:(BOOL)arg3;
