...
@property (weak, nonatomic) id<SBDashBoardDelegatingScreenEdgePanGestureRecognizerDelegate> interfaceDelegate; // @synthesize interfaceDelegate=_interfaceDelegate;
