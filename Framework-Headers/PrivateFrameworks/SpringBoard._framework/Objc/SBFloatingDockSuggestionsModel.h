...
@interface SBFloatingDockSuggestionsModel : NSObject <SBRecentDisplayItemsPersistenceDelegate, SBRecentDisplayItemsControllerDelegate, SBIconListModelObserver>
{
    ...
    BOOL _switcherTransitioning;
    BOOL _dockFolderTransitioning;
    BOOL _pendingSuggestionUpdateForTransition;
...
@property (readonly, nonatomic, getter=_isDockFolderTransitioning) BOOL dockFolderTransitioning; // @synthesize dockFolderTransitioning=_dockFolderTransitioning;
...
@property (readonly, nonatomic, getter=_isPendingSuggestionUpdateForTransition) BOOL pendingSuggestionUpdateForTransition; // @synthesize pendingSuggestionUpdateForTransition=_pendingSuggestionUpdateForTransition;
