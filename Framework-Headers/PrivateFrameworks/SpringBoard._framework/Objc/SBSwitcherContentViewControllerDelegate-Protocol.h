...
- (void)switcherContentController:(id<SBSwitcherContentViewControlling>)arg1 setHomeScreenBackdropBlurProgress:(double)arg2 withAnimationMode:(long long)arg3 completion:(void (^)(BOOL, BOOL))arg4;
- (void)switcherContentController:(id<SBSwitcherContentViewControlling>)arg1 setHomeScreenBackdropBlurType:(long long)arg2;
- (void)switcherContentController:(id<SBSwitcherContentViewControlling>)arg1 setHomeScreenDimmingAlpha:(double)arg2 withAnimationMode:(long long)arg3 completion:(void (^)(BOOL, BOOL))arg4;
