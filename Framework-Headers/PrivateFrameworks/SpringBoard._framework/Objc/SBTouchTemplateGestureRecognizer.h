...
@property (strong, nonatomic, setter=_setNoChangeCancellationTimer:) NSTimer *_noChangeCancellationTimer; // @synthesize _noChangeCancellationTimer;
...
@property (weak, nonatomic) id<SBTouchTemplateGestureRecognizerDelegate> delegate; // @dynamic delegate;
...
@property (strong, nonatomic, getter=_matchedPolygon, setter=_setMatchedPolygon:) SBPolygon *matchedPolygon; // @synthesize matchedPolygon=_matchedPolygon;
@property (strong, nonatomic, getter=_matchedTemplate, setter=_setMatchedTemplate:) SBTouchTemplate *matchedTemplate; // @synthesize matchedTemplate=_matchedTemplate;
