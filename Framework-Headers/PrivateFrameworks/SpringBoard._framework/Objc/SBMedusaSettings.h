...
@property (strong, nonatomic) SBFFluidBehaviorSettings *dockWithPresentedFolderAnimationSettings; // @synthesize dockWithPresentedFolderAnimationSettings=_dockWithPresentedFolderAnimationSettings;
...
@property (strong, nonatomic) SBFFluidBehaviorSettings *platterAnimationSettings; // @synthesize platterAnimationSettings=_platterAnimationSettings;
