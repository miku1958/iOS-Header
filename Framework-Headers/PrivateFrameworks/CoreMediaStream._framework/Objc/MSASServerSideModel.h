...
@property (strong, nonatomic) MSASServerSideModelGroupedCommandQueue *commandQueue; // @synthesize commandQueue=_commandQueue;
...
@property (strong, nonatomic) NSCountedSet *observers; // @synthesize observers=_observers;
@property (strong, nonatomic) MSASPendingChanges *pendingChanges; // @synthesize pendingChanges=_pendingChanges;
