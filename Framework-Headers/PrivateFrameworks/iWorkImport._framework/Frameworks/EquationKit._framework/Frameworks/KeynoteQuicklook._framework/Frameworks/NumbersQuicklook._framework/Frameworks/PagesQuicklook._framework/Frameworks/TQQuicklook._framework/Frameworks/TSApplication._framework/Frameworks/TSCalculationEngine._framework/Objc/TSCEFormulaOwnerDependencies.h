...
@property (nonatomic) BOOL saveAsEmbiggenedFormat; // @synthesize saveAsEmbiggenedFormat=_saveAsEmbiggenedFormat;
...
@property (readonly, strong, nonatomic) TSCEUuidReferences *uuidReferences; // @synthesize uuidReferences=_uuidReferences;
...
- (void)pushRangeAndSpanningDependentsWithCounts:(struct TSCECountedInternalCellRefSet *)arg1 fromCoord:(const struct TSUCellCoord *)arg2 cellIsInACycle:(BOOL)arg3;
