...
+ (BOOL)allowsElementKind:(unsigned int)arg1 forStorageKind:(unsigned char)arg2;
+ (BOOL)allowsSmartFieldKind:(unsigned short)arg1 forStorageKind:(unsigned char)arg2;
...
- (BOOL)allowsElementKind:(unsigned int)arg1;
- (BOOL)allowsElementKind:(unsigned int)arg1 nestingDepth:(long long)arg2;
- (BOOL)allowsSmartFieldKind:(unsigned short)arg1;
...
- (struct _NSRange)attachmentRangeForCharIndex:(unsigned long long)arg1 forwards:(BOOL)arg2 attributeKind:(unsigned long long)arg3;
- (id)attachments;
- (struct TSWPAttributeArray *)attributeArrayForKind:(unsigned long long)arg1;
- (struct TSWPAttributeArray *)attributeArrayForKind:(unsigned long long)arg1 withCreate:(BOOL)arg2;
- (struct TSWPAttributeArray *)attributeArrayForKind:(unsigned long long)arg1 withCreate:(BOOL)arg2 actionState:(struct TSWPStorageActionState *)arg3;
- (struct TSWPAttributeArray *)attributeArrayForKind:(unsigned long long)arg1 withCreate:(BOOL)arg2 fromUndo:(BOOL)arg3 actionState:(struct TSWPStorageActionState *)arg4;
...
- (void)attributesAtCharIndex:(unsigned long long)arg1 attributesOfInterest:(BOOL [23])arg2 attributesTable:(id [23])arg3 effectiveRange:(struct _NSRange *)arg4;
...
- (BOOL)canTransferAttributesForInitialization:(unsigned long long)arg1 withFlags:(unsigned int)arg2;
- (void)capitalizeWithUndoTransaction:(struct TSWPStorageTransaction *)arg1 locale:(id)arg2;
- (void *)cfRetainedNonUndoableFastCopyAttributeRecord:(struct TSWPAttributeRecord *)arg1 shouldAddRecord:(BOOL *)arg2 attributeArrayKind:(unsigned long long)arg3 atIndex:(unsigned long long)arg4 sourceStorage:(id)arg5 objectContext:(id)arg6 flags:(unsigned int)arg7 actionState:(struct TSWPStorageActionState *)arg8;
...
- (BOOL)hasAttachmentsRequiring4_1InRange:(struct _NSRange)arg1;
...
- (BOOL)hasData:(struct TSWPParagraphData)arg1 attribueArrayKind:(unsigned long long)arg2 range:(struct _NSRange)arg3;
...
- (BOOL)hasObject:(id)arg1 attribueArrayKind:(unsigned long long)arg2 range:(struct _NSRange)arg3;
- (BOOL)hasObject:(id)arg1 attribueArrayKind:(unsigned long long)arg2 range:(struct _NSRange)arg3 findUsingExactRangeLocation:(BOOL)arg4;
...
- (BOOL)hasVisibleTextOnlyContentInRange:(struct _NSRange)arg1;
...
- (BOOL)isAllowedToAddCaptionToChildInfo:(id)arg1;
...
- (void)nonUndoableSetWPKind:(unsigned char)arg1 keepHighlights:(BOOL)arg2;
...
- (void)p_attributesAtCharIndex:(unsigned long long)arg1 attributesOfInterest:(BOOL [23])arg2 attributesTable:(id [23])arg3 effectiveRange:(struct _NSRange *)arg4;
...
- (BOOL)p_hasVisibleTextInRange:(struct _NSRange)arg1 graphicalAttachmentsIncluded:(BOOL)arg2;
...
- (struct TSWPParagraphAttributeArray *)paragraphAttributeArrayForKind:(unsigned long long)arg1 withCreate:(BOOL)arg2;
...
- (BOOL)selectionContainsExclusivelyEmptyParagraphs:(id)arg1 ignoreAttachmentCharacters:(BOOL)arg2;
