...
- (int)setCell:(id)arg1 atBaseCellCoord:(struct TSUModelCellCoord)arg2 ignoreFormula:(BOOL)arg3 clearImportWarnings:(BOOL)arg4 calcEngine:(id)arg5;
...
- (void)validate;
- (void)validateTableStylesInSameStylesheetExpectingDocSS:(BOOL)arg1;
