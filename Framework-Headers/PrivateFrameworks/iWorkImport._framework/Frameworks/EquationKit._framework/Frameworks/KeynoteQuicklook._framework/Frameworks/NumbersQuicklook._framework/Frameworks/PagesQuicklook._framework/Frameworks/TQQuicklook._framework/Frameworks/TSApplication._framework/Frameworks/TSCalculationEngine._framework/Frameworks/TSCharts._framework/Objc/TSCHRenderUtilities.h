...
+ (BOOL)centerPointForSeries:(id)arg1 groupIndex:(unsigned long long)arg2 frame:(struct CGRect)arg3 point:(struct CGPoint *)arg4;
+ (BOOL)centerPointForSeries:(id)arg1 groupIndex:(unsigned long long)arg2 frame:(struct CGRect)arg3 point:(struct CGPoint *)arg4 nullsUseIntercept:(BOOL)arg5;
