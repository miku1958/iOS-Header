...
@interface TSTMasterLayout : NSObject <TSTTableHiddenRowColumnProviding, TSTTableInternalGeometryProviding, TSTTableMergeRangeProviding>
{
    ...
    BOOL _dynamicRepResizeSessionInProgress;
...
@property (strong, nonatomic) NSCountedSet *dynamicLayoutParticipants; // @synthesize dynamicLayoutParticipants=_dynamicLayoutParticipants;
...
@property (nonatomic) BOOL dynamicRepResizeSessionInProgress; // @synthesize dynamicRepResizeSessionInProgress=_dynamicRepResizeSessionInProgress;
...
@property (strong, nonatomic) TSTFontInfoCache *fontInfoCache; // @synthesize fontInfoCache=_fontInfoCache;
...
@property (strong, nonatomic) NSObject<OS_dispatch_queue> *layoutConcurrentQueue; // @synthesize layoutConcurrentQueue=_layoutConcurrentQueue;
@property (strong, nonatomic) TSUWidthLimitedQueue *layoutMeasureQueue; // @synthesize layoutMeasureQueue=_layoutMeasureQueue;
@property (strong, nonatomic) TSUWidthLimitedQueue *layoutValidateQueue; // @synthesize layoutValidateQueue=_layoutValidateQueue;
...
@property (strong, nonatomic) TSTMergeRangeSortedSet *mergeRangesForLayoutPass; // @synthesize mergeRangesForLayoutPass=_mergeRangesForLayoutPass;
...
- (double)contentHeightForCellRange:(struct TSUCellRect)arg1 skipDynamicSwap:(BOOL)arg2 maximumPartitionSize:(struct CGSize)arg3;
...
- (id)fittingWidthsMapForColumns:(id)arg1 includeStrokes:(BOOL)arg2;
...
- (double)heightOfRow:(unsigned int)arg1 skipDynamicSwap:(BOOL)arg2 withStrokeHeights:(BOOL)arg3 returnZeroIfHidden:(BOOL)arg4 clampToPartitionSize:(BOOL)arg5 maximumPartitionSize:(struct CGSize)arg6 outIsFitting:(BOOL *)arg7;
...
- (BOOL)isDynamicallyResizingCellIDForColumnRowAdd:(struct TSUCellCoord)arg1;
- (BOOL)isDynamicallyResizingForColumnRowAdd:(long long)arg1;
- (BOOL)isDynamicallyResizingForColumnRowAdd:(long long)arg1 rowColIndex:(unsigned int)arg2;
...
- (void)p_validateFittingInfoWithCellRangeWorker:(struct TSUCellRect)arg1 widthHeightCollection:(id)arg2 containsMerges:(BOOL)arg3 validationBundle:(id)arg4;
