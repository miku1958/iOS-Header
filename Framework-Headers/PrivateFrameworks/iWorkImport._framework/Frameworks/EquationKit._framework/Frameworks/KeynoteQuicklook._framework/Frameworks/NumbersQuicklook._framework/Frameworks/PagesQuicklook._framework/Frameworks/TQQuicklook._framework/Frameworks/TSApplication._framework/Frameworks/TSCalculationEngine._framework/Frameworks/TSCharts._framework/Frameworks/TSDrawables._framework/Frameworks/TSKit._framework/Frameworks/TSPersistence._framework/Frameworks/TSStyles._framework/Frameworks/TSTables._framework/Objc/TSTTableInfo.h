...
@property (strong, nonatomic) TSTArchivedMasterLayoutBundle *archivedMasterLayoutBundle; // @synthesize archivedMasterLayoutBundle=_archivedMasterLayoutBundle;
...
- (id)applyConcurrentCellMapToBaseTable:(id)arg1 options:(unsigned long long)arg2 requestPruneMap:(BOOL)arg3 stylesContainer:(id)arg4 migrationHelper:(id)arg5;
...
- (id)cellMapForRegion:(id)arg1 uidBased:(BOOL)arg2 suppressMergeContent:(BOOL)arg3 useCategoriesWildcards:(BOOL)arg4;
...
- (id)concurrentCellMapForRegion:(id)arg1 suppressMergeContent:(BOOL)arg2;
...
- (void)remapTableUIDsInFormulasWithMap:(const UUIDMap_71b9b5e2 *)arg1 calcEngine:(id)arg2 bakeForBadRefs:(BOOL)arg3;
