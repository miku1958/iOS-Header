...
- (void)drawColumn:(id)arg1 selection:(id)arg2 inContext:(struct CGContext *)arg3 isFlipped:(BOOL)arg4 viewScale:(double)arg5 renderMode:(unsigned long long)arg6;
