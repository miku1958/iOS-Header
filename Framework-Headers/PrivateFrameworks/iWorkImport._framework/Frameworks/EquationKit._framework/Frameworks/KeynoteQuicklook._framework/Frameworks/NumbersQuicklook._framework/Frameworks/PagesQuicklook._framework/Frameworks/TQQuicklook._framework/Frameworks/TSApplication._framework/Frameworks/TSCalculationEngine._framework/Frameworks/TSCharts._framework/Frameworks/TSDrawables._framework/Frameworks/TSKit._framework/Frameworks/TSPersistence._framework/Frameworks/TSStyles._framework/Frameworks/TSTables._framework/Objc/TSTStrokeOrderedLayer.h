...
@property (strong, nonatomic) TSTStrokeLayer *majorStrokeLayer; // @synthesize majorStrokeLayer=_majorStrokeLayer;
@property (strong, nonatomic) TSTStrokeLayer *minorStrokeLayer; // @synthesize minorStrokeLayer=_minorStrokeLayer;
