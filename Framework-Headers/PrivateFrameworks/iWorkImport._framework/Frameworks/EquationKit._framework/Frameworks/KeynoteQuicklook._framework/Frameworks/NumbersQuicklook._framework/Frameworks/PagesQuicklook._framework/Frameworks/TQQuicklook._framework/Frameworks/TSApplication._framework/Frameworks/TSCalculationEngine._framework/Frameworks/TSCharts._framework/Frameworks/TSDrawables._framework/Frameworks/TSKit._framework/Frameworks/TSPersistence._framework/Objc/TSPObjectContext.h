...
+ (long long)documentTypeAtURL:(id)arg1 hasNativeUTI:(BOOL)arg2;
+ (long long)documentTypeAtURL:(id)arg1 hasNativeUTI:(BOOL)arg2 nestedDocumentFilename:(id)arg3;
...
- (BOOL)copyIfAppropriateFromOriginalURL:(id)arg1 toURL:(id)arg2 cloneMode:(BOOL)arg3 originalPackage:(id)arg4 packageType:(long long)arg5 inheritAttributes:(BOOL)arg6;
...
- (BOOL)readObjectForIdentifier:(long long)arg1 isWeakReference:(BOOL)arg2 ignoreUnknownContentWhileReading:(BOOL)arg3 rootObjectComponent:(id)arg4 object:(id *)arg5 error:(id *)arg6;
...
- (BOOL)shouldUseCloneModeToWriteToURL:(id)arg1 originalURL:(id)arg2;
