...
+ (struct _NSRange)charRangeForPencilAnnotationStartPoint:(struct CGPoint)arg1 toEndPoint:(struct CGPoint)arg2 inLayoutTarget:(id)arg3 onSingleLineFragment:(BOOL)arg4;
...
+ (id)commentKnobBaseOriginForHighlightAtTextRange:(struct _NSRange)arg1 withColumns:(id)arg2 positionForRTL:(BOOL)arg3;
...
- (CDStruct_f9ea3fe9)lineMetricsAtCharIndex:(unsigned long long)arg1 allowEndOfLine:(BOOL)arg2;
