...
@property (strong, nonatomic) TSTIntegerKeyDict *data; // @synthesize data=mData;
@property (strong, nonatomic) TSTTableDataObjectKeyDict *dataToKeyDict; // @synthesize dataToKeyDict=mDataToKeyDict;
