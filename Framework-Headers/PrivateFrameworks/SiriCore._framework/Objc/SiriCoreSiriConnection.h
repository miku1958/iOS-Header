...
@property (weak, nonatomic) id<SiriCoreSiriConnectionDelegate> delegate; // @synthesize delegate=_delegate;
...
@property (strong, nonatomic) Class peerStreamProviderClass; // @synthesize peerStreamProviderClass=_peerStreamProviderClass;
