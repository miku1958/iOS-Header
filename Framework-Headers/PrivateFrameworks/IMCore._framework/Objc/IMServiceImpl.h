...
@property (readonly, strong, nonatomic) NSArray *accountIDs;
@property (readonly, strong, nonatomic) NSArray *addressBookProperties; // @synthesize addressBookProperties=_abProperties;
@property (readonly, strong, nonatomic) NSString *addressBookProperty;
...
@property (readonly, strong, nonatomic) NSDictionary *cardMap;
...
@property (readonly, strong, nonatomic) NSArray *emailDomains; // @synthesize emailDomains=_emailDomains;
...
@property (readonly, strong, nonatomic) NSData *serviceImageData;
@property (strong, nonatomic) NSDictionary *serviceProperties;
@property (readonly, strong, nonatomic) NSString *shortName; // @synthesize shortName=_localizedShortName;
...
@property (readonly, strong, nonatomic) NSArray *siblingServices;
