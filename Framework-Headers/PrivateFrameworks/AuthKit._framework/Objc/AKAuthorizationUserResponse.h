...
@property (strong, nonatomic) NSNumber *loginChoice; // @synthesize loginChoice=_loginChoice;
...
@property (strong, nonatomic) AKAuthorizationScopesUserSelection *userSelection; // @synthesize userSelection=_userSelection;
