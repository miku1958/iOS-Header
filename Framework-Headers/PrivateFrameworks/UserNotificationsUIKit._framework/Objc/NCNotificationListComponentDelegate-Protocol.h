...
- (void)notificationListComponent:(id<NCNotificationListComponent>)arg1 requestsPresentingManagementViewForNotificationRequest:(NCNotificationRequest *)arg2 managementViewType:(unsigned long long)arg3 withPresentingView:(UIView *)arg4 completion:(void (^)(BOOL))arg5;
