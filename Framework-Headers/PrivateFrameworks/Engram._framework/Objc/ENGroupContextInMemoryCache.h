...
@property (strong, nonatomic) NSMutableDictionary *groupIDtoGroup; // @synthesize groupIDtoGroup=_groupIDtoGroup;
@property (readonly) unsigned long long hash;
@property (strong, nonatomic) NSMutableDictionary *latestStableGroupIDToGroup; // @synthesize latestStableGroupIDToGroup=_latestStableGroupIDToGroup;
