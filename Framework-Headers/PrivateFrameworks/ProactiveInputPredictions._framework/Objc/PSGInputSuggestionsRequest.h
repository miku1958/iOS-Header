...
@property (readonly, nonatomic) BOOL isDocumentEmpty; // @synthesize isDocumentEmpty=_isDocumentEmpty;
@property (readonly, nonatomic) BOOL isResponseContextBlacklisted; // @synthesize isResponseContextBlacklisted=_isResponseContextBlacklisted;
...
- (id)initWithResponseContext:(id)arg1 conversationTurns:(id)arg2 adaptationContextID:(id)arg3 shouldDisableAutoCaps:(BOOL)arg4 isResponseContextBlacklisted:(BOOL)arg5 contextBeforeInput:(id)arg6 markedText:(id)arg7 selectedText:(id)arg8 contextAfterInput:(id)arg9 selectedRangeInMarkedText:(struct _NSRange)arg10 localeIdentifier:(id)arg11 bundleIdentifier:(id)arg12 recipients:(id)arg13 recipientNames:(id)arg14 textContentType:(id)arg15 availableApps:(id)arg16 textualResponseLimit:(unsigned long long)arg17 structuredInfoLimit:(unsigned long long)arg18 totalSuggestionsLimit:(unsigned long long)arg19;
