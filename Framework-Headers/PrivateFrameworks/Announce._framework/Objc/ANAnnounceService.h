...
- (void)sendAnnouncement:(id)arg1 fromSource:(id)arg2 toHome:(id)arg3 sentHandler:(CDUnknownBlockType)arg4;
- (void)sendAnnouncement:(id)arg1 fromSource:(id)arg2 toRooms:(id)arg3 andZones:(id)arg4 inHome:(id)arg5 sentHandler:(CDUnknownBlockType)arg6;
