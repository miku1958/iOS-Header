...
@property (strong, nonatomic) NSMutableDictionary *URLSessionMap; // @synthesize URLSessionMap=_URLSessionMap;
...
@property (strong, nonatomic) NSURLSession *defaultURLSession; // @synthesize defaultURLSession=_defaultURLSession;
