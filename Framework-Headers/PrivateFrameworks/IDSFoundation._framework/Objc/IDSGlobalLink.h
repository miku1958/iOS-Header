...
- (BOOL)_getPacketBufferSendInfo:(CDStruct_c4cff10b *)arg1 channelNumber:(unsigned short *)arg2 transport:(long long *)arg3;
...
- (BOOL)_processStunPacket:(CDStruct_c4cff10b *)arg1 fromDeviceUniqueID:(id)arg2 cbuuid:(id)arg3 arrivalTime:(double)arg4 headerOverhead:(unsigned long long)arg5;
...
- (BOOL)link:(id)arg1 didReceivePacket:(CDStruct_c4cff10b *)arg2 fromDeviceUniqueID:(id)arg3 cbuuid:(id)arg4;
