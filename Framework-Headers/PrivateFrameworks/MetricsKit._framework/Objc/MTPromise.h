...
@property (strong, nonatomic) MTPromiseCompletionBlocks *completionBlocks; // @synthesize completionBlocks=_completionBlocks;
@property (readonly, nonatomic, getter=isFinished) BOOL finished;
@property (strong, nonatomic) MTPromiseResult *promiseResult; // @synthesize promiseResult=_promiseResult;
