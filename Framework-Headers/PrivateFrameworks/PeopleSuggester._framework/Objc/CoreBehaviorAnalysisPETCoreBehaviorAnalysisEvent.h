...
@property (strong, nonatomic) NSString *confidence; // @synthesize confidence=_confidence;
...
@property (strong, nonatomic) NSString *support; // @synthesize support=_support;
...
@property (strong, nonatomic) NSString *uniqueShareEventIdentifier; // @synthesize uniqueShareEventIdentifier=_uniqueShareEventIdentifier;
