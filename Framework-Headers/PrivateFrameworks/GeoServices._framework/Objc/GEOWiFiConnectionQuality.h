...
@property (strong, nonatomic) NSMutableArray *additionalUniqueIDs; // @synthesize additionalUniqueIDs=_additionalUniqueIDs;
...
@property (strong, nonatomic) NSMutableArray *essMembers; // @synthesize essMembers=_essMembers;
...
@property (strong, nonatomic) NSMutableArray *feedbacks; // @synthesize feedbacks=_feedbacks;
...
@property (strong, nonatomic) NSMutableArray *nearbyBSSs; // @synthesize nearbyBSSs=_nearbyBSSs;
...
@property (strong, nonatomic) NSMutableArray *otherUniqueIDs; // @synthesize otherUniqueIDs=_otherUniqueIDs;
