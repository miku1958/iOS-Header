...
@property (weak, nonatomic) id<GEOConfigChangeListenerDelegate> delegate; // @synthesize delegate;
@property (weak, nonatomic) _GEOConfigKeyHelper *keyHelper; // @synthesize keyHelper;
