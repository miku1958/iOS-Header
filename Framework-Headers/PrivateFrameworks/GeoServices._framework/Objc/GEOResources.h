...
@property (strong, nonatomic) NSMutableArray *attributionBadges; // @synthesize attributionBadges=_attributionBadges;
...
@property (strong, nonatomic) NSString *businessCallerIDURL; // @synthesize businessCallerIDURL=_businessCallerIDURL;
@property (strong, nonatomic) NSString *businessNameResolutionURL; // @synthesize businessNameResolutionURL=_businessNameResolutionURL;
...
@property (strong, nonatomic) NSString *forwardGeocoderURL; // @synthesize forwardGeocoderURL=_forwardGeocoderURL;
...
@property (strong, nonatomic) NSString *problemNotificationAvailabilityURL; // @synthesize problemNotificationAvailabilityURL=_problemNotificationAvailabilityURL;
...
@property (strong, nonatomic) NSString *reverseGeocoderURL; // @synthesize reverseGeocoderURL=_reverseGeocoderURL;
...
@property (strong, nonatomic) NSString *searchURL; // @synthesize searchURL=_searchURL;
