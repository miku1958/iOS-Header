...
@property (strong, nonatomic) GEOPDAllCollectionsViewResultFilterTypeAddress *filterAddress;
@property (strong, nonatomic) GEOPDAllCollectionsViewResultFilterTypeKeyword *filterKeyword;
