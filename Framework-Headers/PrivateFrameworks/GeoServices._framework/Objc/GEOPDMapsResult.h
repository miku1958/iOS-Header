...
@property (strong, nonatomic) GEOPDBatchReverseGeocodeResult *batchReverseGeocode;
@property (strong, nonatomic) GEOPDCollectionResult *collection;
...
@property (strong, nonatomic) GEOPDPublisherResult *publisher;
