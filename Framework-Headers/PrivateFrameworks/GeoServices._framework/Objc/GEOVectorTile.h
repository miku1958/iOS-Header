...
@property (readonly, nonatomic) CDStruct_1d944ba4 *buildingFootprints;
...
- (void)forEachEdgeInRoad:(CDStruct_4da79865 *)arg1 visitTwice:(BOOL)arg2 visitor:(CDUnknownBlockType)arg3;
