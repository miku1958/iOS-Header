...
@property (strong, nonatomic) NSMutableArray *auxiliaryTierRequestedComponents;
...
@property (strong, nonatomic) NSData *handleData;
...
@property (strong, nonatomic) NSMutableArray *requestedComponents;
