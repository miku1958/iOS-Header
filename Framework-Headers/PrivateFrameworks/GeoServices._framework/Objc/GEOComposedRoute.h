...
@property (readonly, nonatomic) BOOL avoidsHighways; // @synthesize avoidsHighways=_avoidsHighways;
@property (readonly, nonatomic) BOOL avoidsTolls; // @synthesize avoidsTolls=_avoidsTolls;
@property (readonly, nonatomic) BOOL avoidsTraffic; // @synthesize avoidsTraffic=_avoidsTraffic;
...
@property (strong, nonatomic) GEOComposedRouteMutableData *mutableData; // @synthesize mutableData=_mutableData;
