...
- (void).cxx_destruct;
- (BOOL)_boundingCircle:(const Sphere_dfb3aa99 *)arg1 intersectsFeature:(CDStruct_a2ef2718 *)arg2;
...
- (BOOL)_boundingCircle:(const Sphere_dfb3aa99 *)arg1 intersectsTransitLink:(CDStruct_32d7d945 *)arg2;
