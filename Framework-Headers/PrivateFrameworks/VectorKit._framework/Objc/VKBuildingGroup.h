...
- (id).cxx_construct;
- (void).cxx_destruct;
- (void)addBuilding:(CDStruct_4bb03b42 *)arg1 index:(unsigned long long)arg2 ofTotal:(unsigned long long)arg3 accessor:(struct ResourceAccessor *)arg4 triangulator:(id)arg5 prepareExtrusion:(BOOL)arg6 forRoofStyle:(unsigned char)arg7 scaleThreshold:(float)arg8;
...
- (BOOL)addPointyRoofForBuilding:(CDStruct_4bb03b42 *)arg1 buildingModel:(unsigned char)arg2 scaleThreshold:(float)arg3 styleIndex:(float)arg4;
- (BOOL)canConstructPointyRoofForPolygon:(CDStruct_64195c06 *)arg1 building:(CDStruct_4bb03b42 *)arg2 buildingModel:(unsigned char)arg3 scaleThreshold:(float)arg4;
