...
- (void)addPolygon:(CDStruct_dbfa07c5 *)arg1 hasNonWaterStyle:(BOOL)arg2 accessor:(struct ResourceAccessor *)arg3 triangulator:(id)arg4;
...
- (void)prepareForPolygon:(CDStruct_dbfa07c5 *)arg1 hasNonWaterStyle:(BOOL)arg2;
