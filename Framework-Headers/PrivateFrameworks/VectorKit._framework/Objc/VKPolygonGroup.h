...
- (id).cxx_construct;
- (void).cxx_destruct;
- (void)addExtrusionForPolygon:(CDStruct_d7f4d903 *)arg1 building:(CDStruct_957c25a5 *)arg2 index:(unsigned long long)arg3 ofTotal:(unsigned long long)arg4 hasNonWaterStyle:(BOOL)arg5 triangulator:(id)arg6 forRoofStyle:(int)arg7;
- (BOOL)addPointyRoofForPolygon:(CDStruct_d7f4d903 *)arg1 building:(CDStruct_957c25a5 *)arg2 buildingModel:(unsigned char)arg3 scaleThreshold:(float)arg4 styleIndex:(float)arg5;
- (void)addPolygon:(CDStruct_d7f4d903 *)arg1 building:(CDStruct_957c25a5 *)arg2 index:(unsigned long long)arg3 ofTotal:(unsigned long long)arg4 hasNonWaterStyle:(BOOL)arg5 accessor:(struct ResourceAccessor *)arg6 triangulator:(id)arg7 prepareExtrusion:(BOOL)arg8 forRoofStyle:(int)arg9 scaleThreshold:(float)arg10;
...
- (BOOL)canConstructPointyRoofForPolygon:(CDStruct_d7f4d903 *)arg1 building:(CDStruct_957c25a5 *)arg2 buildingModel:(unsigned char)arg3 scaleThreshold:(float)arg4;
...
- (void)prepareForPolygon:(CDStruct_d7f4d903 *)arg1 building:(CDStruct_957c25a5 *)arg2 hasNonWaterStyle:(BOOL)arg3 forRoofStyle:(int)arg4 scaleThreshold:(float)arg5;
