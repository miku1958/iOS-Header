...
- (double)altitude;
- (void)animatePath:(vector_e91c9c3b *)arg1 animator:(const shared_ptr_781019ee *)arg2 preloadedRequiredViews:(unordered_map_6683d8a9 *)arg3 prePruneData:(BOOL)arg4 completionHandler:(CDUnknownBlockType)arg5;
- (void)animatePath:(vector_e91c9c3b *)arg1 withTarget:(const Geocentric_d8fde6f2 *)arg2 lookAtTarget:(BOOL)arg3 constantLod:(BOOL)arg4 prePruneData:(BOOL)arg5 completionHandler:(CDUnknownBlockType)arg6;
...
- (void)moveAlongPath:(struct PathAnimationDescription)arg1 tap:(struct TapDescription)arg2 preloadedViews:(unordered_map_6683d8a9)arg3 continued:(BOOL)arg4;
