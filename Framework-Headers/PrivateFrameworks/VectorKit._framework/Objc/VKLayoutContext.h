...
@property (strong, nonatomic) VKAnchorContext *anchorContext; // @synthesize anchorContext=_anchorContext;
...
@property (strong, nonatomic) VKCamera *transitionCamera; // @synthesize transitionCamera=_transitionCamera;
@property (nonatomic) long long transitionMapMode; // @synthesize transitionMapMode=_transitionMapMode;
@property (strong, nonatomic) VKViewTransform *viewTransform; // @synthesize viewTransform=_viewTransform;
