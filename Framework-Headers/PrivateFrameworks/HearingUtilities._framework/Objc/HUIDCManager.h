...
@property (weak, nonatomic) id<HUIDCManagerSecurityDelegate> securityDelegate; // @synthesize securityDelegate=_securityDelegate;
@property (strong, nonatomic) NSString *serviceType; // @synthesize serviceType=_serviceType;
@property (strong, nonatomic) HUIDCSlaveController *slaveController; // @synthesize slaveController=_slaveController;
