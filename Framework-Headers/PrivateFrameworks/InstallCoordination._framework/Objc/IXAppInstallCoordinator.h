...
+ (void)_demoteAppToPlaceholderWithBundleID:(id)arg1 forReason:(unsigned long long)arg2 waitForDeletion:(BOOL)arg3 ignoreRemovability:(BOOL)arg4 completion:(CDUnknownBlockType)arg5;
...
+ (void)demoteAppToPlaceholderWithBundleID:(id)arg1 forReason:(unsigned long long)arg2 waitForDeletion:(BOOL)arg3 completion:(CDUnknownBlockType)arg4;
...
+ (void)demoteAppToPlaceholderWithBundleID:(id)arg1 forReason:(unsigned long long)arg2 waitForDeletion:(BOOL)arg3 ignoreRemovability:(BOOL)arg4 completion:(CDUnknownBlockType)arg5;
...
+ (void)installApplication:(id)arg1 toTargetDirectory:(id)arg2 consumeSource:(BOOL)arg3 options:(id)arg4 completion:(CDUnknownBlockType)arg5;
+ (void)installApplication:(id)arg1 toTargetDirectory:(id)arg2 consumeSource:(BOOL)arg3 shouldOverrideGatekeeper:(BOOL)arg4 options:(id)arg5 completion:(CDUnknownBlockType)arg6;
+ (void)installApplication:(id)arg1 toURL:(id)arg2 consumeSource:(BOOL)arg3 options:(id)arg4 completion:(CDUnknownBlockType)arg5;
+ (void)installApplication:(id)arg1 toURL:(id)arg2 consumeSource:(BOOL)arg3 shouldOverrideGatekeeper:(BOOL)arg4 options:(id)arg5 completion:(CDUnknownBlockType)arg6;
