...
- (void).cxx_destruct;
- (id)_handleControlCodeAtIndex:(unsigned int)arg1 withBuffer:(CDStruct_f9502b4c)arg2 totalLength:(unsigned long long)arg3 consumedLength:(unsigned int *)arg4 hadEmpties:(BOOL *)arg5 containsPrivacySensitiveContents:(BOOL *)arg6 externalProviders:(BOOL *)arg7;
- (id)_handleOptionalAtIndex:(unsigned int)arg1 withBuffer:(CDStruct_f9502b4c)arg2 totalLength:(unsigned long long)arg3 consumedLength:(unsigned int *)arg4 containsPrivacySensitiveContents:(BOOL *)arg5 externalProviders:(BOOL *)arg6;
- (id)_handleProviderAtIndex:(unsigned int)arg1 withBuffer:(CDStruct_f9502b4c)arg2 totalLength:(unsigned long long)arg3 consumedLength:(unsigned int *)arg4 containsPrivacySensitiveContents:(BOOL *)arg5 hadEmpties:(BOOL *)arg6 externalProviders:(BOOL *)arg7;
