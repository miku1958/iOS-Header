...
@property (strong, nonatomic) NSArray *beamSearches; // @synthesize beamSearches=_beamSearches;
...
@property (strong) CRTextDetectorModel *ocrDetectorModel; // @synthesize ocrDetectorModel=_ocrDetectorModel;
@property (strong) CRTextRecognizerModel *ocrRecognizerModel; // @synthesize ocrRecognizerModel=_ocrRecognizerModel;
...
@property (strong) CRPerformanceStatistics *singleFeatureLMStats; // @synthesize singleFeatureLMStats=_singleFeatureLMStats;
@property (strong) CRPerformanceStatistics *singleFeatureRecognizerStats; // @synthesize singleFeatureRecognizerStats=_singleFeatureRecognizerStats;
@property (strong) NSOrderedSet *targetLanguages; // @synthesize targetLanguages=_targetLanguages;
