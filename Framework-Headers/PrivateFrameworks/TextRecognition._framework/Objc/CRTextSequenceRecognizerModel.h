...
@property (strong, nonatomic) NSDictionary *outputShape; // @synthesize outputShape=_outputShape;
@property (strong, nonatomic) NSNumber *outputWidthDownscale; // @synthesize outputWidthDownscale=_outputWidthDownscale;
@property (strong, nonatomic) NSNumber *outputWidthOffset; // @synthesize outputWidthOffset=_outputWidthOffset;
