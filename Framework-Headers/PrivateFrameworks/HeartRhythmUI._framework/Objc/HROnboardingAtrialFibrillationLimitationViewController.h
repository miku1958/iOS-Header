...
@property (strong, nonatomic) UIView *backgroundView1; // @synthesize backgroundView1=_backgroundView1;
@property (strong, nonatomic) UIView *backgroundView2; // @synthesize backgroundView2=_backgroundView2;
...
@property (strong, nonatomic) HRTitledListItemLabel *titledListItemLabel1; // @synthesize titledListItemLabel1=_titledListItemLabel1;
@property (strong, nonatomic) HRTitledListItemLabel *titledListItemLabel2; // @synthesize titledListItemLabel2=_titledListItemLabel2;
@property (strong, nonatomic) HRTitledListItemLabel *titledListItemLabel3; // @synthesize titledListItemLabel3=_titledListItemLabel3;
