...
@interface VCStatisticsCollectorQueue : NSObject
{
    ...
    CDStruct_1a067c5f _messageQueue[300];
...
- (BOOL)addStatisticsMessage:(CDStruct_1a067c5f)arg1;
- (void)cancelWait;
- (void)dealloc;
- (BOOL)dequeue:(CDStruct_1a067c5f *)arg1;
- (void)drainAndProcessAllStatistics;
- (BOOL)enqueue:(CDStruct_1a067c5f)arg1;
...
- (BOOL)isQueueFull;
- (void)processMessage:(CDStruct_1a067c5f)arg1;
- (int)queueSize;
- (void)start;
- (void)stop;
- (void)stopThread;
