...
@interface VCStatisticsCollectorQueue : NSObject
{
    ...
    CDStruct_bae76c55 _messageQueue[300];
...
- (BOOL)addStatisticsMessage:(CDStruct_bae76c55)arg1;
- (void)cancelWait;
- (void)dealloc;
- (BOOL)dequeue:(CDStruct_bae76c55 *)arg1;
- (void)drainAndProcessAllStatistics;
- (BOOL)enqueue:(CDStruct_bae76c55)arg1;
...
- (BOOL)isQueueFull;
- (void)processMessage:(CDStruct_bae76c55)arg1;
- (int)queueSize;
- (void)start;
- (void)stop;
- (void)stopThread;
