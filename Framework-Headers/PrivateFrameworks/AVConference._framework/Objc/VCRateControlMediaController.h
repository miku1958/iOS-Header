...
@property (nonatomic) BOOL enableAggressiveProbingSequence; // @synthesize enableAggressiveProbingSequence=_enableAggressiveProbingSequence;
...
- (void)updateBasebandSuggestionWithStatistics:(CDStruct_bae76c55)arg1;
