...
- (void)addActualBitrateInfo:(CDStruct_1a067c5f *)arg1;
- (void)addEntriesFromStatistics:(CDStruct_1a067c5f)arg1;
- (void)addMostBurstyLossInfo:(CDStruct_1a067c5f *)arg1;
- (void)addPacketLossInfo:(CDStruct_1a067c5f *)arg1;
- (void)addRoundTripTimeInfo:(CDStruct_1a067c5f *)arg1;
- (void)addStatisticsHistory:(CDStruct_1a067c5f *)arg1;
- (void)computeBWEstimation:(CDStruct_1a067c5f *)arg1;
- (void)computeOWRDEstimation:(CDStruct_1a067c5f *)arg1;
- (void)computeOtherStatistics:(CDStruct_1a067c5f *)arg1;
- (void)dealloc;
- (void)drainAndProcessVCStatistics:(CDStruct_1a067c5f)arg1;
- (void)enableBWELogDump:(void *)arg1;
- (id)getStatistics:(id)arg1;
- (CDStruct_1a067c5f)getVCStatisticsWithType:(int)arg1 time:(double)arg2;
- (id)init;
- (id)initForSimulation:(BOOL)arg1 useExternalThread:(BOOL)arg2;
- (void)processVCStatisticsInternal:(CDStruct_1a067c5f)arg1;
- (void)recordRemoteEstimatedBandwidthForLargeFrameInfo:(CDStruct_1a067c5f *)arg1;
...
- (void)updatePacketReceivedCount:(CDStruct_1a067c5f *)arg1;
