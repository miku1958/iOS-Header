...
- (void)addActualBitrateInfo:(CDStruct_bae76c55 *)arg1;
- (void)addEntriesFromStatistics:(CDStruct_bae76c55)arg1;
- (void)addMostBurstyLossInfo:(CDStruct_bae76c55 *)arg1;
- (void)addPacketLossInfo:(CDStruct_bae76c55 *)arg1;
- (void)addRoundTripTimeInfo:(CDStruct_bae76c55 *)arg1;
- (void)addStatisticsHistory:(CDStruct_bae76c55 *)arg1;
- (void)computeBWEstimation:(CDStruct_bae76c55 *)arg1;
- (void)computeOWRDEstimation:(CDStruct_bae76c55 *)arg1;
- (void)computeOtherStatistics:(CDStruct_bae76c55 *)arg1;
- (void)dealloc;
- (void)drainAndProcessVCStatistics:(CDStruct_bae76c55)arg1;
- (void)enableBWELogDump:(void *)arg1;
- (id)getStatistics:(id)arg1;
- (CDStruct_bae76c55)getVCStatisticsWithType:(int)arg1 time:(double)arg2;
- (id)init;
- (id)initForSimulation:(BOOL)arg1 useExternalThread:(BOOL)arg2;
- (void)processVCStatisticsInternal:(CDStruct_bae76c55)arg1;
- (void)recordRemoteEstimatedBandwidthForLargeFrameInfo:(CDStruct_bae76c55 *)arg1;
...
- (void)updatePacketReceivedCount:(CDStruct_bae76c55 *)arg1;
