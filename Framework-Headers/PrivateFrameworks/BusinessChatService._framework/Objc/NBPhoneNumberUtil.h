...
@property (strong, nonatomic) NBMetadataHelper *helper; // @synthesize helper=_helper;
@property (strong, nonatomic) NSLock *lockPatternCache; // @synthesize lockPatternCache=_lockPatternCache;
@property (strong, nonatomic) NBRegExMatcher *matcher; // @synthesize matcher=_matcher;
