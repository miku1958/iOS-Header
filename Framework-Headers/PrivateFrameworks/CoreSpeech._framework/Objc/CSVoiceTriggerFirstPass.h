...
@property (strong, nonatomic) NSDictionary *channelSelectionScores; // @synthesize channelSelectionScores=_channelSelectionScores;
...
@property (strong, nonatomic) NSDictionary *onsetResult; // @synthesize onsetResult=_onsetResult;
...
@property (strong, nonatomic) CSPolicy *voiceTriggerStartPolicy; // @synthesize voiceTriggerStartPolicy=_voiceTriggerStartPolicy;
