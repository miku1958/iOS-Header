...
@property (strong, nonatomic) NSMutableData *audioBuffer; // @synthesize audioBuffer=_audioBuffer;
...
@property (strong, nonatomic) NSMutableArray *rmsSamplesForEntireAudio; // @synthesize rmsSamplesForEntireAudio=_rmsSamplesForEntireAudio;
