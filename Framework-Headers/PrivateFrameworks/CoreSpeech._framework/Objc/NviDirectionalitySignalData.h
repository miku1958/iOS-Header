...
@property (strong, nonatomic) NSDictionary *azDistribution; // @synthesize azDistribution=_azDistribution;
...
@property (strong, nonatomic) NSArray *spatialSpectrumData; // @synthesize spatialSpectrumData=_spatialSpectrumData;
