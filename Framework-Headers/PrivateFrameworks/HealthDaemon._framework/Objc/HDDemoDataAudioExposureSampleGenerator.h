...
@property (strong, nonatomic) NSDate *lastEnvironmentalSampleEndDate; // @synthesize lastEnvironmentalSampleEndDate=_lastEnvironmentalSampleEndDate;
@property (strong, nonatomic) NSDate *lastHeadphoneSampleEndDate; // @synthesize lastHeadphoneSampleEndDate=_lastHeadphoneSampleEndDate;
