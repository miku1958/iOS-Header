...
- (void)_remote_saveObjects:(NSArray *)arg1 deleteObjects:(NSArray *)arg2 associations:(NSDictionary *)arg3 completion:(void (^)(BOOL, NSError *))arg4;
...
- (void)remote_removePreferredUnitForType:(HKQuantityType *)arg1 completion:(void (^)(BOOL, NSError *))arg2;
