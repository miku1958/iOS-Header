...
@property (strong, nonatomic) HDDemoDataSleepParameters *weekdaySleepParameters; // @synthesize weekdaySleepParameters=_weekdaySleepParameters;
@property (strong, nonatomic) HDDemoDataSleepParameters *weekendSleepParameters; // @synthesize weekendSleepParameters=_weekendSleepParameters;
...
@property (strong, nonatomic) NSArray *weightGainHolidayDaysInYear; // @synthesize weightGainHolidayDaysInYear=_weightGainHolidayDaysInYear;
...
@property (strong, nonatomic) NSDictionary *workoutPrototypesByCalendarDay; // @synthesize workoutPrototypesByCalendarDay=_workoutPrototypesByCalendarDay;
