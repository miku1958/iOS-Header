...
+ (id)foreignKeys;
+ (BOOL)generateSyncObjectsForSession:(id)arg1 syncEntityClass:(Class)arg2 predicate:(id)arg3 syncAnchorRange:(struct HDSyncAnchorRange)arg4 profile:(id)arg5 messageHandler:(id)arg6 error:(id *)arg7;
+ (id)indices;
