...
- (BOOL)_defaultIterScoresForTopicMapping:(id)arg1 query:(id)arg2 error:(id *)arg3 clientProcessName:(id)arg4 block:(CDUnknownBlockType)arg5;
...
- (BOOL)iterScoredTopicsWithQuery:(id)arg1 error:(id *)arg2 clientProcessName:(id)arg3 block:(CDUnknownBlockType)arg4;
- (BOOL)iterScoresForTopicMapping:(id)arg1 query:(id)arg2 error:(id *)arg3 block:(CDUnknownBlockType)arg4;
- (BOOL)iterScoresForTopicMapping:(id)arg1 query:(id)arg2 error:(id *)arg3 clientProcessName:(id)arg4 block:(CDUnknownBlockType)arg5;
