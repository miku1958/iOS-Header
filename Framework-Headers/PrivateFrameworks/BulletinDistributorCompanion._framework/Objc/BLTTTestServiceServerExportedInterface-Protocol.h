...
- (void)addBulletin:(BBBulletin *)arg1 forFeed:(unsigned long long)arg2 playLightsAndSirens:(BOOL)arg3 attachment:(NSData *)arg4 attachmentType:(long long)arg5 alwaysSend:(BOOL)arg6 completion:(void (^)(BOOL))arg7;
