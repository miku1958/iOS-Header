...
@property (strong, nonatomic) RMCoreOrganization *sourceOrganizationEnqueued; // @dynamic sourceOrganizationEnqueued;
@property (strong, nonatomic) RMCoreOrganization *sourceOrganizationPending; // @dynamic sourceOrganizationPending;
@property (strong, nonatomic) RMCoreOrganization *sourceOrganizationRecent; // @dynamic sourceOrganizationRecent;
