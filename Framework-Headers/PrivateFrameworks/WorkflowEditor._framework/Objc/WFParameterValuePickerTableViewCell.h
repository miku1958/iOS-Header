...
@property (strong, nonatomic) WFParameter<WFParameterValuePickable> *parameter; // @synthesize parameter=_parameter;
@property (strong, nonatomic) WFCodableAttributeBackedSubstitutableState *state; // @synthesize state=_state;
