...
@property (readonly, strong, nonatomic) SBCameraHardwareButtonDefaults *cameraHardwareButtonDefaults;
...
@property (readonly, strong, nonatomic) SBStateDumpDefaults *stateDumpDefaults;
