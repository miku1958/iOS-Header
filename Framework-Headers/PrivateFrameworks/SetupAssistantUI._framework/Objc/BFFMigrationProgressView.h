...
@property (strong, nonatomic) NSDateComponentsFormatter *elapsedDurationFormatter; // @synthesize elapsedDurationFormatter=_elapsedDurationFormatter;
@property (strong) NSString *internalProgressText; // @synthesize internalProgressText=_internalProgressText;
