...
@property (nonatomic, strong) _TtC18HealthPlatformCore11FeedSection *feedSection; // @dynamic feedSection;
@property (nonatomic) BOOL hideInDiscover; // @dynamic hideInDiscover;
@property (nonatomic) BOOL indexForSearch; // @dynamic indexForSearch;
@property (nonatomic) BOOL isFavorite; // @dynamic isFavorite;
