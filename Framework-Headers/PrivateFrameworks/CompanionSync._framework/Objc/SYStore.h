...
@property (weak, nonatomic) id<SYStoreDelegate> delegate; // @synthesize delegate=_delegate;
...
@property (strong, nonatomic) SYStoreResetSessionOwner *pendingResetSessionOwner; // @synthesize pendingResetSessionOwner=_pendingResetSessionOwner;
@property (readonly, nonatomic) SYPersistentStore *persistentStore; // @synthesize persistentStore=_persistentStore;
@property (nonatomic) long long priority;
@property (strong, nonatomic) id<SYSerialization> serializer; // @synthesize serializer=_serializer;
@property (strong, nonatomic) SYStoreSessionOwner *sessionOwner; // @synthesize sessionOwner=_sessionOwner;
