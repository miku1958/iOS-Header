...
@property (strong, nonatomic) NSString *cancelButtonString; // @synthesize cancelButtonString=_cancelButtonString;
@property (strong, nonatomic) AMSProcessInfo *clientInfo; // @synthesize clientInfo=_clientInfo;
@property (strong, nonatomic) NSString *companionDeviceClientInfo; // @synthesize companionDeviceClientInfo=_companionDeviceClientInfo;
@property (strong, nonatomic) NSString *companionDeviceUDID; // @synthesize companionDeviceUDID=_companionDeviceUDID;
...
@property (nonatomic) BOOL enableAccountCreation; // @synthesize enableAccountCreation=_enableAccountCreation;
