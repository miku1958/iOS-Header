...
- (oneway void)submitInstanceScore:(long long)arg1 context:(unsigned long long)arg2 leaderboardID:(NSString *)arg3 forPlayer:(GKPlayerInternal *)arg4 whileScreeningChallenges:(BOOL)arg5 withEligibleChallenges:(NSArray *)arg6 handler:(void (^)(NSError *))arg7;
- (oneway void)submitScore:(long long)arg1 context:(unsigned long long)arg2 leaderboardIDs:(NSArray *)arg3 forPlayer:(GKPlayerInternal *)arg4 whileScreeningChallenges:(BOOL)arg5 withEligibleChallenges:(NSArray *)arg6 handler:(void (^)(NSError *))arg7;
