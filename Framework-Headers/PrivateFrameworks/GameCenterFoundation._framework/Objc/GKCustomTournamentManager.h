...
@property (strong, nonatomic) GKPlayer *creator; // @synthesize creator=_creator;
@property (weak, nonatomic) GKTournament *tournament; // @synthesize tournament=_tournament;
