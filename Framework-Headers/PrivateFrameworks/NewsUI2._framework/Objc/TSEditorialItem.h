...
@property (nonatomic, strong) id<FCTagProviding> backingTag; // @synthesize backingTag;
@property (nonatomic, strong) id<FCHeadlineProviding> headline; // @synthesize headline;
@property (nonatomic, copy) NSString *identifier;
@property (nonatomic, copy) NSString *subtitle;
@property (nonatomic, copy) NSString *subtitleColor;
@property (nonatomic, strong) UIImage *thumbnailImage; // @synthesize thumbnailImage;
