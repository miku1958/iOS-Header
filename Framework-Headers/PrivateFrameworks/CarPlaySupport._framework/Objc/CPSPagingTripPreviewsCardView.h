...
@property (strong, nonatomic) NSLayoutConstraint *alternateRoutesHeightConstraint; // @synthesize alternateRoutesHeightConstraint=_alternateRoutesHeightConstraint;
...
@property (strong, nonatomic) NSLayoutConstraint *contentBottomConstraint; // @synthesize contentBottomConstraint=_contentBottomConstraint;
@property (strong, nonatomic) NSLayoutConstraint *contentTopConstraint; // @synthesize contentTopConstraint=_contentTopConstraint;
...
@property (strong, nonatomic) NSLayoutConstraint *toggleRoutesButtonHeightConstraint; // @synthesize toggleRoutesButtonHeightConstraint=_toggleRoutesButtonHeightConstraint;
