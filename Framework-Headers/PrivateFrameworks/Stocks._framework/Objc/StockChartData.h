...
@property (strong, nonatomic) NSDictionary *dataSeriesDict; // @synthesize dataSeriesDict=_dataSeriesDict;
...
@property (strong, nonatomic) NSArray *interestingIndexes; // @synthesize interestingIndexes=_interestingIndexes;
@property (nonatomic) BOOL isUnavailable; // @synthesize isUnavailable=_isUnavailable;
@property (strong, nonatomic) NSDate *marketCloseDate; // @synthesize marketCloseDate=_marketCloseDate;
@property (strong, nonatomic) NSDate *marketOpenDate; // @synthesize marketOpenDate=_marketOpenDate;
@property (strong, nonatomic) NSTimeZone *marketTimeZone; // @synthesize marketTimeZone=_marketTimeZone;
...
@property (weak, nonatomic) Stock *stock; // @synthesize stock=_stock;
