...
@property (strong, nonatomic) NSString *accessoryPairingUsername; // @synthesize accessoryPairingUsername=_accessoryPairingUsername;
...
@property (weak, nonatomic) HAPAccessoryServerBrowserBTLE *browser; // @synthesize browser=_browser;
...
@property (strong, nonatomic, getter=getStateNumber) NSNumber *stateNumber; // @synthesize stateNumber=_stateNumber;
