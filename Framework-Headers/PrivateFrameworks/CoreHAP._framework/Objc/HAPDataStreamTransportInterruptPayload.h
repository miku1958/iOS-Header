...
@property (strong, nonatomic) HAPTLVUnsignedNumberValue *dataStreamTransportInterruptSequenceNumber; // @synthesize dataStreamTransportInterruptSequenceNumber=_dataStreamTransportInterruptSequenceNumber;
@property (readonly, copy) NSString *debugDescription;
@property (readonly, copy) NSString *description;
@property (readonly) unsigned long long hash;
@property (strong, nonatomic) NSData *requestToSendIdentifiers; // @synthesize requestToSendIdentifiers=_requestToSendIdentifiers;
