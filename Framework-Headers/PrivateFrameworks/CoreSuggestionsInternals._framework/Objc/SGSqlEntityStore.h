...
- (void)_enumerateContactsForMasterEntityIds:(id)arg1 withSnippets:(BOOL)arg2 usingBlock:(CDUnknownBlockType)arg3;
...
- (void)enumerateAllContactsWithSnippets:(BOOL)arg1 limitTo:(unsigned long long)arg2 usingBlock:(CDUnknownBlockType)arg3;
- (void)enumerateContactsByMasterEntityQuery:(id)arg1 withSnippets:(BOOL)arg2 limit:(unsigned long long)arg3 bindings:(CDUnknownBlockType)arg4 usingBlock:(CDUnknownBlockType)arg5;
...
- (id)suggestContactsByMasterEntityQuery:(id)arg1 withSnippets:(BOOL)arg2 limit:(unsigned long long)arg3 bindings:(CDUnknownBlockType)arg4;
