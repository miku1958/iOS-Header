...
@property (strong, nonatomic) UIAlertController *rebootDeviceAlertController; // @synthesize rebootDeviceAlertController=_rebootDeviceAlertController;
...
- (BOOL)_accessibilityShowNewControlCenter:(BOOL)arg1;
