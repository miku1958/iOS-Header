...
@property (weak, nonatomic) id<WFPythonHTMLParserDelegate> delegate; // @synthesize delegate=_delegate;
...
@property (strong, nonatomic) NSRegularExpression *interestingExpression; // @synthesize interestingExpression=_interestingExpression;
