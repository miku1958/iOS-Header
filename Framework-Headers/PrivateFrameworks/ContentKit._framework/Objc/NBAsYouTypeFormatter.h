...
@property (strong, nonatomic) NSString *DIGIT_PLACEHOLDER_; // @synthesize DIGIT_PLACEHOLDER_=_DIGIT_PLACEHOLDER_;
...
@property (strong, nonatomic) NBPhoneMetaData *EMPTY_METADATA_; // @synthesize EMPTY_METADATA_=_EMPTY_METADATA_;
