...
@property (nonatomic) BOOL isAudioActionMenuResizing; // @synthesize isAudioActionMenuResizing=_isAudioActionMenuResizing;
@property (nonatomic) BOOL isAudioActionMenuSuspended; // @synthesize isAudioActionMenuSuspended=_isAudioActionMenuSuspended;
...
@property (strong, nonatomic) CKComposition *previousAudioComposition; // @synthesize previousAudioComposition=_previousAudioComposition;
