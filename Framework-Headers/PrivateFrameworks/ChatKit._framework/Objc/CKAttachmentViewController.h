...
@property (strong, nonatomic) NSMutableArray *mediaObjects; // @synthesize mediaObjects=_mediaObjects;
...
@property (strong, nonatomic) CKTranscriptRecipientsController *recipientsController; // @synthesize recipientsController=_recipientsController;
