...
@property (strong, nonatomic) CKAcknowledgmentGlyphImageView *a1; // @synthesize a1=_a1;
@property (strong, nonatomic) CKAcknowledgmentGlyphImageView *a2; // @synthesize a2=_a2;
@property (strong, nonatomic) CKAcknowledgmentGlyphImageView *h1; // @synthesize h1=_h1;
@property (strong, nonatomic) CKAcknowledgmentGlyphImageView *h2; // @synthesize h2=_h2;
