...
@property (strong) NSMutableArray *delegates; // @synthesize delegates=_delegates;
@property (readonly, copy) NSString *description;
@property (readonly) unsigned long long hash;
@property (strong) FPItemCollection *itemCollection; // @synthesize itemCollection=_itemCollection;
@property (strong) id<FPItemCollectionIndexPathBasedDelegate> soleUpdatableDelegate; // @synthesize soleUpdatableDelegate=_soleUpdatableDelegate;
@property (strong) NSMutableArray *subscribers; // @synthesize subscribers=_subscribers;
