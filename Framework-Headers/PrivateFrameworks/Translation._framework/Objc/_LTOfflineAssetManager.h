...
- (void)_downloadPassthroughAssetForLocale:(id)arg1 userInitiated:(BOOL)arg2 completion:(CDUnknownBlockType)arg3;
...
- (void)purgeAllAssetsExcludingConfig:(BOOL)arg1 completion:(CDUnknownBlockType)arg2;
- (void)purgeAssetForLanguagePair:(id)arg1 userInitiated:(BOOL)arg2 completion:(CDUnknownBlockType)arg3;
