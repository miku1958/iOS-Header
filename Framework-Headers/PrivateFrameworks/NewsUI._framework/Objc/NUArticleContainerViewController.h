...
@property (weak, nonatomic) id<NUArticleContainerViewControllerDelegate> delegate; // @synthesize delegate=_delegate;
...
@property (strong, nonatomic) id<NUPaging> paging; // @synthesize paging=_paging;
