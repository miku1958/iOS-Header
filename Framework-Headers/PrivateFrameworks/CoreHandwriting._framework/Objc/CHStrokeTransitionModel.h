...
@property (readonly, strong, nonatomic) NSString *charBoundaryProbabilityOutputName; // @synthesize charBoundaryProbabilityOutputName=_charBoundaryProbabilityOutputName;
@property (readonly, nonatomic) long long cosAlphaFeatureIndex; // @synthesize cosAlphaFeatureIndex=_cosAlphaFeatureIndex;
@property (readonly, strong, nonatomic) NSString *delayedStrokeProbabilityOutputName; // @synthesize delayedStrokeProbabilityOutputName=_delayedStrokeProbabilityOutputName;
...
@property (readonly, strong, nonatomic) NSString *spaceProbabilityOutputName; // @synthesize spaceProbabilityOutputName=_spaceProbabilityOutputName;
