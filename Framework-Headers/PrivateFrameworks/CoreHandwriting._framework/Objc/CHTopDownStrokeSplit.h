...
@property (readonly, strong, nonatomic) NSArray *orderedStrokes; // @synthesize orderedStrokes=_orderedStrokes;
@property (readonly, strong, nonatomic) NSArray *orderedStrokesGroup1; // @synthesize orderedStrokesGroup1=_orderedStrokesGroup1;
@property (readonly, strong, nonatomic) NSArray *orderedStrokesGroup2; // @synthesize orderedStrokesGroup2=_orderedStrokesGroup2;
@property (readonly, strong, nonatomic) NSArray *strokeGroup1; // @synthesize strokeGroup1=_strokeGroup1;
@property (readonly, strong, nonatomic) NSArray *strokeGroup2; // @synthesize strokeGroup2=_strokeGroup2;
