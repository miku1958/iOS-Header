...
- (void)reloadWithErrorCallback:(void (^)(NSString *))arg1 successCallback:(void (^)(void))arg2 ignoreCache:(BOOL *)arg3 revalidateAllResources:(BOOL *)arg4 scriptToEvaluateOnLoad:(id *)arg5;
