...
@property (readonly, strong, nonatomic) NSString *baseName; // @synthesize baseName=_baseName;
@property (readonly, strong, nonatomic) NSString *folder; // @synthesize folder=_folder;
