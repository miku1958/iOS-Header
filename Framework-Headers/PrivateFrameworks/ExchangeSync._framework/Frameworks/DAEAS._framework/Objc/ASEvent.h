...
@property (strong, nonatomic) NSArray *deletedAttachmentsIDs; // @synthesize deletedAttachmentsIDs=_deletedAttachmentsIDs;
...
@property (nonatomic) BOOL isOrganizerUpdate; // @synthesize isOrganizerUpdate=_isOrganizerUpdate;
