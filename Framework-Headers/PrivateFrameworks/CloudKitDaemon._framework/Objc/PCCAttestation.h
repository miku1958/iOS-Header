...
@property (strong, nonatomic) NSData *applicationEnclaveQuote; // @synthesize applicationEnclaveQuote=_applicationEnclaveQuote;
@property (strong, nonatomic) NSString *certificate; // @synthesize certificate=_certificate;
@property (strong, nonatomic) NSData *quotingEnclaveQuote; // @synthesize quotingEnclaveQuote=_quotingEnclaveQuote;
