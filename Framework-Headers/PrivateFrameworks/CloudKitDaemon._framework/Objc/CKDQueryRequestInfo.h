...
@property (weak, nonatomic) CKDQueryOperation *operation; // @synthesize operation=_operation;
...
@property (strong, nonatomic) CKDQueryURLRequest *request; // @synthesize request=_request;
