...
@property (strong, nonatomic) NPKPassSyncChange *passSyncEngineSyncTimerCandidateChange; // @synthesize passSyncEngineSyncTimerCandidateChange=_passSyncEngineSyncTimerCandidateChange;
@property (strong, nonatomic) NPKPassSyncChange *passSyncEngineSyncTimerProcessingChange; // @synthesize passSyncEngineSyncTimerProcessingChange=_passSyncEngineSyncTimerProcessingChange;
