...
@property (strong, nonatomic) NSString *selectedVerificationChannelIdentifier; // @synthesize selectedVerificationChannelIdentifier=_selectedVerificationChannelIdentifier;
