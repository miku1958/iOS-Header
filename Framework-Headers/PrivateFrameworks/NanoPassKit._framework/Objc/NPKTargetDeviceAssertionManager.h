...
@property (strong, nonatomic) NSMutableDictionary *assertTypesUUIDsMap; // @synthesize assertTypesUUIDsMap=_assertTypesUUIDsMap;
@property (strong, nonatomic) NSMutableDictionary *outstandingAssertionStatusUpdaters; // @synthesize outstandingAssertionStatusUpdaters=_outstandingAssertionStatusUpdaters;
