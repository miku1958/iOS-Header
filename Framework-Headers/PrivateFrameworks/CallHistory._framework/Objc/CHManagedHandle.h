...
@property (strong, nonatomic) NSSet *localParticipantCalls; // @dynamic localParticipantCalls;
@property (copy, nonatomic) NSString *normalizedValue; // @dynamic normalizedValue;
@property (strong, nonatomic) NSSet *remoteParticipantCalls; // @dynamic remoteParticipantCalls;
