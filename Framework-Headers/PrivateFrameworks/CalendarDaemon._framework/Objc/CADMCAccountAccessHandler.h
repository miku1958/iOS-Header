...
@property (strong, nonatomic) NSArray *cachedAccounts; // @synthesize cachedAccounts=_cachedAccounts;
@property (strong, nonatomic) NSMutableDictionary *cachedRestrictedStoreInfos; // @synthesize cachedRestrictedStoreInfos=_cachedRestrictedStoreInfos;
