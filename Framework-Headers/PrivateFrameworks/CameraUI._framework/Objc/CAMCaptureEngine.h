...
@property (strong, nonatomic, setter=_setResultsQueueLastCompletedVideoURL:) NSURL *_resultsQueueLastCompletedVideoURL; // @synthesize _resultsQueueLastCompletedVideoURL=__resultsQueueLastCompletedVideoURL;
