...
@property (readonly, nonatomic, getter=isUnifiedBracketingSupported) BOOL unifiedBracketingSupported; // @synthesize unifiedBracketingSupported=_unifiedBracketingSupported;
