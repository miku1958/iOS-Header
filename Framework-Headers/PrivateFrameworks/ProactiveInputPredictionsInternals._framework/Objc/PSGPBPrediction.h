...
@property (nonatomic) BOOL portraitTimeout; // @synthesize portraitTimeout=_portraitTimeout;
@property (nonatomic) BOOL requiredAppUnavailable; // @synthesize requiredAppUnavailable=_requiredAppUnavailable;
