...
@property (strong) TCMessageContext *messageContext; // @synthesize messageContext=mMessageContext;
@property (strong) TCProgressContext *progressContext; // @synthesize progressContext=mProgressContext;
