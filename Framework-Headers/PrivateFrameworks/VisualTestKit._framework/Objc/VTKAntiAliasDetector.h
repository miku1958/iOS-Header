...
@property (strong, nonatomic) VTKBitmapContext *leftContext; // @synthesize leftContext=_leftContext;
@property (strong, nonatomic) VTKBitmapContext *rightContext; // @synthesize rightContext=_rightContext;
