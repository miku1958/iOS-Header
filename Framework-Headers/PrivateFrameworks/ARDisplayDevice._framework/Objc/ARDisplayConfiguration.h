...
@property (strong, nonatomic) NSNumber *verticalAlignmentPosition; // @synthesize verticalAlignmentPosition=_verticalAlignmentPosition;
@property (strong) NSNumber *verticalMarkerPoint; // @synthesize verticalMarkerPoint=_verticalMarkerPoint;
