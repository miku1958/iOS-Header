...
@property (strong) XCElementSnapshot *rootElementSnapshot; // @synthesize rootElementSnapshot=_rootElementSnapshot;
...
@property (strong) id<XCTElementSetTransformer> transformer; // @synthesize transformer=_transformer;
