...
+ (BOOL)_cornerRadiiFromImgTreatmentValue:(id)arg1 width:(double)arg2 cornerRadii:(struct _VUICornerRadii *)arg3 circle:(BOOL *)arg4;
+ (BOOL)_cornerRadiiWithBorderRadius:(id)arg1 cornerRadii:(struct _VUICornerRadii *)arg2 imageWidth:(double)arg3 imageTreatmentValue:(id)arg4 circle:(BOOL *)arg5;
...
+ (const struct CGPath *)createPathForRadii:(struct _VUICornerRadii)arg1 inRect:(struct CGRect)arg2 isContinuous:(BOOL)arg3;
...
+ (BOOL)radiiIsZero:(struct _VUICornerRadii)arg1;
