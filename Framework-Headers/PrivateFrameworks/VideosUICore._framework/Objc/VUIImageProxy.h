...
@property (strong, nonatomic) VUIImageDecorator *decorator; // @synthesize decorator=_decorator;
@property (strong, nonatomic) _VUIDecoratorRequest *decoratorRequestToken; // @synthesize decoratorRequestToken=_decoratorRequestToken;
