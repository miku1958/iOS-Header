...
@property (strong) BKSProcessAssertion *bkProcessAssertion; // @synthesize bkProcessAssertion=_bkProcessAssertion;
@property (strong) id expirationObserver; // @synthesize expirationObserver=_expirationObserver;
