...
@property (strong, nonatomic) NSString *composerName; // @synthesize composerName=_composerName;
...
@property (strong, nonatomic) NSString *genreName; // @synthesize genreName=_genreName;
