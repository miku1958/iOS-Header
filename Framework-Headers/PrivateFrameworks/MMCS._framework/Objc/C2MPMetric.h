...
@property (strong, nonatomic) C2MPClientInfo *clientInfo; // @synthesize clientInfo=_clientInfo;
...
@property (strong, nonatomic) C2MPNetworkStatistic *networkStatistic; // @synthesize networkStatistic=_networkStatistic;
