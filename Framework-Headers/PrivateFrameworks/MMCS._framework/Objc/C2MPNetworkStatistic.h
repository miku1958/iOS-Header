...
@property (strong, nonatomic) NSString *networkConnectionUuid; // @synthesize networkConnectionUuid=_networkConnectionUuid;
...
@property (strong, nonatomic) NSString *networkRequestUri; // @synthesize networkRequestUri=_networkRequestUri;
...
@property (strong, nonatomic) NSString *networkTaskDescription; // @synthesize networkTaskDescription=_networkTaskDescription;
...
@property (strong, nonatomic) NSString *optionsSourceApplicationBundleIdentifier; // @synthesize optionsSourceApplicationBundleIdentifier=_optionsSourceApplicationBundleIdentifier;
@property (strong, nonatomic) NSString *optionsSourceApplicationSecondaryIdentifier; // @synthesize optionsSourceApplicationSecondaryIdentifier=_optionsSourceApplicationSecondaryIdentifier;
