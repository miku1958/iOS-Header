...
@property (strong, nonatomic) C2RequestOptions *warmOptions; // @synthesize warmOptions=_warmOptions;
@property (strong, nonatomic) NSMutableURLRequest *warmRequest; // @synthesize warmRequest=_warmRequest;
@property (strong, nonatomic) NSURLSessionTask *warmTask; // @synthesize warmTask=_warmTask;
