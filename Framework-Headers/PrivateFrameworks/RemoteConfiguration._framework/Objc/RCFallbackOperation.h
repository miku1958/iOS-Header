...
@property (strong, nonatomic) RCConfigurationResource *cachedConfigurationResource; // @synthesize cachedConfigurationResource=_cachedConfigurationResource;
...
@property (strong, nonatomic) RCConfigurationResource *configurationResource; // @synthesize configurationResource=_configurationResource;
...
@property (strong, nonatomic) NSURL *fallbackURL; // @synthesize fallbackURL=_fallbackURL;
