...
@property (strong, nonatomic) NSArray *requiredMeaningfulEventTraits; // @synthesize requiredMeaningfulEventTraits=_requiredMeaningfulEventTraits;
...
- (id)insertMomentForClueCollection:(id)arg1 feeder:(id)arg2 ingestPeople:(BOOL)arg3 progressBlock:(CDUnknownBlockType)arg4;
