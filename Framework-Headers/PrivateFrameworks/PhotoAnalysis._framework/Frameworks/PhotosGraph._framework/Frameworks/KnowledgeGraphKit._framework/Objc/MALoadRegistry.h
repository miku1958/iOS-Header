...
@interface MALoadRegistry : NSObject
{
    ...
    _Atomic BOOL _purgeInProgress;
}

@property (strong, nonatomic) MADatabase *database; // @synthesize database=_database;
@property (strong, nonatomic) NSMutableSet *deregisteredLoadRequirements; // @synthesize deregisteredLoadRequirements=_deregisteredLoadRequirements;
@property (strong, nonatomic) MAGraph *graph; // @synthesize graph=_graph;
@property (strong, nonatomic) NSMutableSet *loadedEdgeRequirements; // @synthesize loadedEdgeRequirements=_loadedEdgeRequirements;
@property (strong, nonatomic) NSMutableSet *loadedNodeRequirements; // @synthesize loadedNodeRequirements=_loadedNodeRequirements;
@property (strong, nonatomic) NSMutableArray *pendingEdgeRequirements; // @synthesize pendingEdgeRequirements=_pendingEdgeRequirements;
@property (strong, nonatomic) NSMutableArray *pendingNodeRequirements; // @synthesize pendingNodeRequirements=_pendingNodeRequirements;
@property (strong, nonatomic) NSMutableSet *registeredLoadRequirements; // @synthesize registeredLoadRequirements=_registeredLoadRequirements;
