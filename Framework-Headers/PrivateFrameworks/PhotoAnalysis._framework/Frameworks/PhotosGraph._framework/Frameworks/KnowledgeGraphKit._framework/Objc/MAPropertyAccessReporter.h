...
@property (strong, nonatomic) NSMutableDictionary *countByPropertyKey; // @synthesize countByPropertyKey=_countByPropertyKey;
@property (strong, nonatomic) NSMutableDictionary *countByTuple; // @synthesize countByTuple=_countByTuple;
@property (strong, nonatomic) NSString *dumpPath; // @synthesize dumpPath=_dumpPath;
