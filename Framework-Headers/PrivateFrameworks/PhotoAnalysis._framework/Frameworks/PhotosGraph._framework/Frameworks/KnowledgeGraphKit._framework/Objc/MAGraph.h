...
@property (readonly, nonatomic, getter=isPropertyLoadingEnabled) BOOL propertyLoadingEnabled;
@property (readonly) Class superclass;
@property (nonatomic) BOOL usesIdentifyingProperties; // @synthesize usesIdentifyingProperties=_usesIdentifyingProperties;
