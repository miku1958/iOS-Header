...
@property (strong, nonatomic) NSArray *negativeLocalIdentifiers; // @synthesize negativeLocalIdentifiers=_negativeLocalIdentifiers;
...
@property (strong, nonatomic) NSArray *positiveLocalIdentifiers; // @synthesize positiveLocalIdentifiers=_positiveLocalIdentifiers;
