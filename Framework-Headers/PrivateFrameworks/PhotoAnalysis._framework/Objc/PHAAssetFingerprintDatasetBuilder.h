...
@property (strong, nonatomic) PHACoreDuetDatasetStorage *datasetStore; // @synthesize datasetStore=_datasetStore;
...
@property (strong, nonatomic) NSArray *negativeAssetIdentifiers; // @synthesize negativeAssetIdentifiers=_negativeAssetIdentifiers;
...
@property (strong, nonatomic) NSArray *positiveAssetIdentifiers; // @synthesize positiveAssetIdentifiers=_positiveAssetIdentifiers;
