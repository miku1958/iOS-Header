...
+ (struct CGAffineTransform)rotationTransformForRectangularAnnotation:(id)arg1 hasRotation:(BOOL *)arg2;
...
- (struct CGRect)annotationLayerFrameForAnnotation:(id)arg1 layerIsClipped:(BOOL *)arg2;
