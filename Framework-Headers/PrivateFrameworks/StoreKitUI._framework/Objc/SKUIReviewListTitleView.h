...
@property (strong, nonatomic) SKUIAttributedStringView *dateView; // @synthesize dateView=_dateView;
@property (readonly, copy) NSString *debugDescription;
@property (readonly, copy) NSString *description;
@property (readonly) unsigned long long hash;
@property (readonly) Class superclass;
@property (strong, nonatomic) SKUIAttributedStringView *titleView; // @synthesize titleView=_titleView;
