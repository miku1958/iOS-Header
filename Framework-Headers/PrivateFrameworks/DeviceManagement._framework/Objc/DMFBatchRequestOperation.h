...
@property (strong, nonatomic) CATRemoteTaskOperation *activityTransactionOperation; // @synthesize activityTransactionOperation=_activityTransactionOperation;
@property (strong, nonatomic) CATOperationQueue *queue; // @synthesize queue=_queue;
