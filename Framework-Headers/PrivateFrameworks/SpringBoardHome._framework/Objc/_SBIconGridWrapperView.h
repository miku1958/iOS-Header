...
@property (strong, nonatomic) _SBFolderPageElement *element; // @synthesize element=_element;
@property (weak, nonatomic) SBFolderIconImageView *folderIconImageView; // @synthesize folderIconImageView=_folderIconImageView;
