...
- (BOOL)iconScrollView:(SBIconScrollView *)arg1 shouldSetAutoscrollContentOffset:(struct CGPoint)arg2;
- (BOOL)iconScrollView:(SBIconScrollView *)arg1 shouldSetContentOffset:(struct CGPoint *)arg2 animated:(BOOL)arg3;
