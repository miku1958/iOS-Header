...
@property (strong) CKContainer *container; // @synthesize container=_container;
@property (strong) NSObject<OS_dispatch_group> *group; // @synthesize group=_group;
@property (strong) id<_DKKeyValueStore> keyValueStore; // @synthesize keyValueStore=_keyValueStore;
@property (strong) NSOperationQueue *operationQueue; // @synthesize operationQueue=_operationQueue;
@property (weak) _DKKnowledgeStorage *storage; // @synthesize storage=_storage;
