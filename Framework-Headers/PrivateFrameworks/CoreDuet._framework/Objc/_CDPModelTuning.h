...
@property (strong, nonatomic) _CDPSimpleModel *model; // @synthesize model=_model;
...
@property (strong, nonatomic) NSIndexSet *testIndices; // @synthesize testIndices=_testIndices;
