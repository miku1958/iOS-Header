...
@property (strong, nonatomic) NSData *_DKAppInstallMetadataKey__subCategories; // @dynamic _DKAppInstallMetadataKey__subCategories;
...
@property (strong, nonatomic) NSData *_DKBehavioralRuleFeaturesMetadataKey__featureDict; // @dynamic _DKBehavioralRuleFeaturesMetadataKey__featureDict;
...
@property (nonatomic) BOOL _DKDeviceIsPluggedInMetadataKey__adapterIsWireless; // @dynamic _DKDeviceIsPluggedInMetadataKey__adapterIsWireless;
...
@property (nonatomic) BOOL _DKDigitalHealthMetadataKey__isUsageTrusted; // @dynamic _DKDigitalHealthMetadataKey__isUsageTrusted;
...
@property (strong, nonatomic) NSData *_DKDiscoverabilityUsageMetadataKey__analyticsEvent; // @dynamic _DKDiscoverabilityUsageMetadataKey__analyticsEvent;
...
@property (strong, nonatomic) NSData *_DKDiscoverabilityUsageMetadataKey__eligibleContext; // @dynamic _DKDiscoverabilityUsageMetadataKey__eligibleContext;
...
@property (strong, nonatomic) NSData *_DKFamilyPredictionMetadataKey__suggestions; // @dynamic _DKFamilyPredictionMetadataKey__suggestions;
...
@property (strong, nonatomic) NSData *_DKIntentMetadataKey__serializedInteraction; // @dynamic _DKIntentMetadataKey__serializedInteraction;
...
@property (strong, nonatomic) NSData *_DKLocationApplicationActivityMetadataKey__phoneNumbers; // @dynamic _DKLocationApplicationActivityMetadataKey__phoneNumbers;
...
@property (strong, nonatomic) NSData *_DKMetadataHomeKitAccessoryControl__accessoryState; // @dynamic _DKMetadataHomeKitAccessoryControl__accessoryState;
...
@property (nonatomic) BOOL _DKMetadataHomeKitAccessoryControl__eligibleForSuggestions; // @dynamic _DKMetadataHomeKitAccessoryControl__eligibleForSuggestions;
...
@property (strong, nonatomic) NSData *_DKMetadataHomeKitScene__associatedAccessoryUUIDs; // @dynamic _DKMetadataHomeKitScene__associatedAccessoryUUIDs;
...
@property (strong, nonatomic) NSData *_DKMicroLocationMetadataKey__probabilityVector; // @dynamic _DKMicroLocationMetadataKey__probabilityVector;
...
@property (strong, nonatomic) NSData *_DKNowPlayingMetadataKey__outputDeviceIDs; // @dynamic _DKNowPlayingMetadataKey__outputDeviceIDs;
...
@property (strong, nonatomic) NSData *_DKPeopleSuggesterOutputForSiriNLMetadataKey__rankedSuggestions; // @dynamic _DKPeopleSuggesterOutputForSiriNLMetadataKey__rankedSuggestions;
...
@property (strong, nonatomic) NSData *_DKRelevantShortcutMetadataKey__serializedRelevantShortcut; // @dynamic _DKRelevantShortcutMetadataKey__serializedRelevantShortcut;
...
@property (strong, nonatomic) NSData *_DKShareSheetFeedbackMetadataKey__attachments; // @dynamic _DKShareSheetFeedbackMetadataKey__attachments;
...
@property (strong, nonatomic) NSData *_DKShareSheetFeedbackMetadataKey__locationUUIDs; // @dynamic _DKShareSheetFeedbackMetadataKey__locationUUIDs;
@property (strong, nonatomic) NSData *_DKShareSheetFeedbackMetadataKey__modelSuggestionProxies; // @dynamic _DKShareSheetFeedbackMetadataKey__modelSuggestionProxies;
...
@property (strong, nonatomic) NSData *_DKShareSheetFeedbackMetadataKey__photoSuggestedContacts; // @dynamic _DKShareSheetFeedbackMetadataKey__photoSuggestedContacts;
...
@property (strong, nonatomic) NSData *_DKSiriIntentEventMetadataKey__eventData; // @dynamic _DKSiriIntentEventMetadataKey__eventData;
...
@property (strong, nonatomic) NSData *_QPMetricsMetadataKey__CandidateList; // @dynamic _QPMetricsMetadataKey__CandidateList;
...
@property (strong, nonatomic) NSData *_QPMetricsMetadataKey__QueryList; // @dynamic _QPMetricsMetadataKey__QueryList;
