...
@property (weak, nonatomic) id<MSDifferentialPrivacyDataSource> _dataSource; // @synthesize _dataSource;
@property (strong, nonatomic) MSMailDynamicDataAsset *_mailDynamicData; // @synthesize _mailDynamicData;
