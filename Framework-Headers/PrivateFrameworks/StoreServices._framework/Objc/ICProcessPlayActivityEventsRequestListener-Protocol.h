...
- (void)acquirePendingPlayActivityEventsForEndpointIdentifier:(NSString *)arg1 storeAccountID:(unsigned long long)arg2 shouldFilterStoreAccountID:(BOOL)arg3 withReplyBlock:(void (^)(NSArray *, unsigned long long, NSError *))arg4;
