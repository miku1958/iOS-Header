...
@property (strong, nonatomic) SSPromiseCompletionBlocks *completionBlocks; // @synthesize completionBlocks=_completionBlocks;
@property (readonly, nonatomic, getter=isFinished) BOOL finished;
@property (strong, nonatomic) SSPromiseResult *promiseResult; // @synthesize promiseResult=_promiseResult;
