...
@property (strong, nonatomic) UIView *bottomRightAccessoryView; // @synthesize bottomRightAccessoryView=_bottomRightAccessoryView;
@property (nonatomic, getter=isDimmed) BOOL dimmed;
@property (nonatomic) BOOL drawsBorder;
@property (strong, nonatomic) UIView *leftAccessoryView; // @synthesize leftAccessoryView=_leftAccessoryView;
