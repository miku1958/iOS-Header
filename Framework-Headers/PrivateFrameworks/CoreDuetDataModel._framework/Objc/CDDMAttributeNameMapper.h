...
@property (strong, nonatomic) NSString *associatedPools; // @dynamic associatedPools;
...
@property (strong, nonatomic) NSString *dataProtectionClass; // @dynamic dataProtectionClass;
@property (strong, nonatomic) NSNumber *estimatedCadenceSeconds; // @dynamic estimatedCadenceSeconds;
