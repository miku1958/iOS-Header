...
@property (strong, nonatomic) NSNumber *batteryLevel; // @dynamic batteryLevel;
@property (strong, nonatomic) NSNumber *computedDischargeRateMilliwatts; // @dynamic computedDischargeRateMilliwatts;
...
@property (strong, nonatomic) NSNumber *sampledMilliwatts; // @dynamic sampledMilliwatts;
