...
@property (strong, nonatomic) NADelegateMethodLogSettings *logSettings; // @synthesize logSettings=_logSettings;
...
@property (strong, nonatomic) NSArray *overrideObservers; // @synthesize overrideObservers=_overrideObservers;
