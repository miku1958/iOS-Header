...
@property (strong, nonatomic) NSMutableString *debugLog; // @synthesize debugLog=_debugLog;
@property (readonly, copy) NSString *description;
@property (readonly) unsigned long long hash;
@property (strong, nonatomic) id<MFQueryableLibraryAdapter> library; // @synthesize library=_library;
@property (strong, nonatomic) NSCache *mailboxIDCache; // @synthesize mailboxIDCache=_mailboxIDCache;
@property (strong, nonatomic) NSDictionary *parameters; // @synthesize parameters=_parameters;
@property (readonly) Class superclass;
@property (strong, nonatomic) id<MFUserProfileProvider> userProfileProvider; // @synthesize userProfileProvider=_userProfileProvider;
