...
@property (strong, nonatomic) NSMutableSet *modes; // @synthesize modes=_modes;
@property (copy, nonatomic) CDUnknownBlockType queuedBlock; // @synthesize queuedBlock=_queuedBlock;
@property (strong, nonatomic) NSMutableArray *queuedBlocks; // @synthesize queuedBlocks=_queuedBlocks;
