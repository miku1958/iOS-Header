...
@property (strong, nonatomic) id<SiriUIActivityIndicatorTemplateModel> templateModel; // @dynamic templateModel;
@property (strong, nonatomic) SiriUIActivityIndicatorTemplateView *view; // @dynamic view;
