...
@property (weak, nonatomic) id<CSPersistentContentLayoutProviding><CSDateTimeLayoutAggregating> persistentLayout; // @synthesize persistentLayout=_persistentLayout;
