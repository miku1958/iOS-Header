...
@property (strong, nonatomic) UIView *reduceTransparencyBackingView; // @synthesize reduceTransparencyBackingView=_reduceTransparencyBackingView;
@property (strong, nonatomic) UIView *reduceTransparencyTintingView; // @synthesize reduceTransparencyTintingView=_reduceTransparencyTintingView;
