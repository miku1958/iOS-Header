...
@property (strong, nonatomic) NSNumber *cleanupPending; // @synthesize cleanupPending=_cleanupPending;
...
@property (strong, nonatomic) NSNumber *familyAccountID; // @synthesize familyAccountID=_familyAccountID;
@property (nonatomic) unsigned long long fileSize; // @synthesize fileSize=_fileSize;
@property (copy, nonatomic) NSString *genre; // @synthesize genre=_genre;
@property (copy, nonatomic) NSString *hashType; // @synthesize hashType=_hashType;
@property (strong, nonatomic) NSNumber *isAutomaticDownload; // @synthesize isAutomaticDownload=_isAutomaticDownload;
...
@property (strong, nonatomic) NSNumber *isRestore; // @synthesize isRestore=_isRestore;
@property (strong, nonatomic) NSNumber *isSample; // @synthesize isSample=_isSample;
@property (strong, nonatomic) NSNumber *isZipStreamable; // @synthesize isZipStreamable=_isZipStreamable;
...
@property (strong, nonatomic) NSNumber *publicationVersion; // @synthesize publicationVersion=_publicationVersion;
@property (strong, nonatomic) NSDate *purchaseDate; // @synthesize purchaseDate=_purchaseDate;
@property (strong, nonatomic) NSNumber *serverNumberOfBytesToHash; // @synthesize serverNumberOfBytesToHash=_serverNumberOfBytesToHash;
...
@property (strong, nonatomic) NSNumber *storePlaylistIdentifier; // @synthesize storePlaylistIdentifier=_storePlaylistIdentifier;
