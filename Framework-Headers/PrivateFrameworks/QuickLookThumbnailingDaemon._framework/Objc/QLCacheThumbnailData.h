...
@property (strong, nonatomic) QLCacheBlobInfo *bitmapDataToValidate; // @synthesize bitmapDataToValidate=_bitmapDataToValidate;
...
@property (readonly, nonatomic) BOOL iconMode; // @synthesize iconMode=_iconMode;
...
@property (strong, nonatomic) QLCacheBlobInfo *metadataToValidate; // @synthesize metadataToValidate=_metadataToValidate;
