...
@property BOOL isCorrupted; // @synthesize isCorrupted=_isCorrupted;
@property (strong) NSString *tracingPrefix; // @synthesize tracingPrefix=_tracingPrefix;
...
- (void)executeWithCallback:(CDUnknownFunctionPointerType)arg1 context:(void *)arg2 rollbackOnError:(BOOL)arg3 sql:(const char *)arg4 arguments:(struct __va_list_tag [1])arg5;
