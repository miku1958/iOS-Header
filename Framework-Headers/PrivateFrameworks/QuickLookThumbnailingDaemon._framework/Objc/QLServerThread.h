...
@property (strong) NSObject<OS_dispatch_queue> *completionBlocksQueue; // @synthesize completionBlocksQueue=_completionBlocksQueue;
@property (strong) NSMutableDictionary *currentFetchThumbnailsOperations; // @synthesize currentFetchThumbnailsOperations=_currentFetchThumbnailsOperations;
@property (strong) NSMutableDictionary *externalThumbnailCacheAvailablePendingBlocks; // @synthesize externalThumbnailCacheAvailablePendingBlocks=_externalThumbnailCacheAvailablePendingBlocks;
@property (strong) NSMutableDictionary *externalThumbnailCacheInboxURLs; // @synthesize externalThumbnailCacheInboxURLs=_externalThumbnailCacheInboxURLs;
@property (strong) NSObject<OS_dispatch_queue> *externalThumbnailCacheQueue; // @synthesize externalThumbnailCacheQueue=_externalThumbnailCacheQueue;
@property (strong) NSMutableDictionary *externalThumbnailCacheThumbnailURLs; // @synthesize externalThumbnailCacheThumbnailURLs=_externalThumbnailCacheThumbnailURLs;
@property (strong) NSMutableDictionary *externalThumbnailCaches; // @synthesize externalThumbnailCaches=_externalThumbnailCaches;
@property (strong) NSMutableSet *knownDomainsWithoutExternalThumbnailCaches; // @synthesize knownDomainsWithoutExternalThumbnailCaches=_knownDomainsWithoutExternalThumbnailCaches;
...
@property (strong) NSMutableDictionary *queuedDownloadRequests; // @synthesize queuedDownloadRequests=_queuedDownloadRequests;
...
- (void)_notifyGenerationHandlerOfThumbnailGenerationForRequest:(id)arg1 bitmapData:(id)arg2 format:(id)arg3 metadata:(id)arg4 contentRect:(struct CGRect)arg5 iconFlavor:(int)arg6 thumbnailRepresentation:(long long)arg7 clientShouldTakeOwnership:(BOOL)arg8 error:(id)arg9;
...
- (void)addImageData:(id)arg1 withBitmapFormat:(id)arg2 contentRect:(struct CGRect)arg3 hasIconModeApplied:(BOOL)arg4 flavor:(int)arg5 metadata:(id)arg6 toCacheAndCompleteRequest:(id)arg7;
- (void)cancelThumbnailRequests:(id)arg1;
- (void)completeThumbnailRequest:(id)arg1 bitmapData:(id)arg2 metadata:(id)arg3 contentRect:(struct CGRect)arg4 thumbnailRepresentation:(long long)arg5 iconFlavor:(int)arg6 format:(id)arg7 clientShouldTakeOwnership:(BOOL)arg8;
...
- (void)generateThumbnailForThumbnailRequest:(id)arg1 item:(id)arg2 atTaggedLogicalURL:(id)arg3 shouldUpdateGenstore:(BOOL)arg4 completionHandler:(CDUnknownBlockType)arg5;
...
- (void)processLargeThumbnailData:(id)arg1 withContentType:(id)arg2 precacheThumbnails:(BOOL)arg3 forRequest:(id)arg4 url:(id)arg5 completionHandler:(CDUnknownBlockType)arg6;
...
- (void)reset;
- (void)sendResultForThumbnailRequest:(id)arg1 bitmapData:(id)arg2 format:(id)arg3 metadata:(id)arg4 contentRect:(struct CGRect)arg5 iconFlavor:(int)arg6 thumbnailRepresentation:(long long)arg7 clientShouldTakeOwnership:(BOOL)arg8 reenqueueRequest:(BOOL)arg9 error:(id)arg10;
