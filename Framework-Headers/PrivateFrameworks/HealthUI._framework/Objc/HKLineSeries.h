...
@property (strong, nonatomic) HKLineSeriesPointMarkerStyle *selectedPointMarkerStyle; // @synthesize selectedPointMarkerStyle=_selectedPointMarkerStyle;
...
- (void)_renderLegendPointLabelInContext:(struct CGContext *)arg1 point:(struct CGPoint)arg2 untransformedPoint:(struct CGPoint)arg3 presentationStyle:(id)arg4 leftOfPoint:(BOOL)arg5;
