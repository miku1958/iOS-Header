...
@property (strong, nonatomic) UIImage *outOfRangeSelectedMarker; // @synthesize outOfRangeSelectedMarker=_outOfRangeSelectedMarker;
@property (strong, nonatomic) UIImage *outOfRangeUnselectedMarker; // @synthesize outOfRangeUnselectedMarker=_outOfRangeUnselectedMarker;
@property (strong, nonatomic) UIImage *withinRangeSelectedMarker; // @synthesize withinRangeSelectedMarker=_withinRangeSelectedMarker;
@property (strong, nonatomic) UIImage *withinRangeUnselectedMarker; // @synthesize withinRangeUnselectedMarker=_withinRangeUnselectedMarker;
