...
@property (nonatomic) BOOL useCKNative; // @synthesize useCKNative=_useCKNative;
@property (readonly, weak, nonatomic) id<TRIXPCActivityManagementProtocol> xpcActivityManager; // @synthesize xpcActivityManager=_xpcActivityManager;
