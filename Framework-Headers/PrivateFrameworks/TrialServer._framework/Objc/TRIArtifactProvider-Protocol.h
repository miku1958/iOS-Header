...
- (void)fetchExperimentNotificationsWithNamespaceNames:(NSSet *)arg1 rollbacksOnly:(BOOL)arg2 lastFetchDateOverride:(NSDate *)arg3 options:(TRIDownloadOptions *)arg4 resultsHandler:(void (^)(unsigned long long, NSArray *, NSDate *, NSError *))arg5;
