...
@property (strong, nonatomic) _CPTCPInfo *startTimeCounts; // @synthesize startTimeCounts=_startTimeCounts;
@property (strong, nonatomic) _CPTCPInfo *stopTimeCounts; // @synthesize stopTimeCounts=_stopTimeCounts;
@property (readonly) Class superclass;
@property (nonatomic) double timingDataInit; // @synthesize timingDataInit=_timingDataInit;
@property (strong, nonatomic) _CPTuscanyConnectionInfo *tuscany; // @synthesize tuscany=_tuscany;
