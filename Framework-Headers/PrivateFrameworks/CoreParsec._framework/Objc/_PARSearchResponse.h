...
@property (strong, nonatomic) _PARSearchResponse_Error *error; // @synthesize error=_error;
...
@property (strong, nonatomic) _PARSearchResponse_QueryFeatures *queryFeatures; // @synthesize queryFeatures=_queryFeatures;
