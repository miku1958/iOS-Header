...
@property (weak, nonatomic) id<VSTwoFactorEntryViewModelDelegate> delegate; // @synthesize delegate=_delegate;
...
@property (strong, nonatomic) VSTwoFactorEntryTextField *twoFactorTextField; // @synthesize twoFactorTextField=_twoFactorTextField;
