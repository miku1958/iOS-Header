...
@property (strong, nonatomic) NSString *eqPreset; // @synthesize eqPreset=_eqPreset;
...
@property (strong, nonatomic) NSString *playbackFormat; // @synthesize playbackFormat=_playbackFormat;
