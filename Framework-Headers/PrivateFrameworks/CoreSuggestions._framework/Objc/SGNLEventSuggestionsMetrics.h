...
@property (strong, nonatomic) SGMDDLinkShown *ddLinkShown; // @synthesize ddLinkShown=_ddLinkShown;
@property (strong, nonatomic) SGMNLEventInBanner *nlEvent; // @synthesize nlEvent=_nlEvent;
