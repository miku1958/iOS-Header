...
@property (strong) OBBoldTrayButton *setAppLimitButton; // @synthesize setAppLimitButton=_setAppLimitButton;
@property (strong, nonatomic) STIntroAppLimitsTableViewController *tableViewController;
