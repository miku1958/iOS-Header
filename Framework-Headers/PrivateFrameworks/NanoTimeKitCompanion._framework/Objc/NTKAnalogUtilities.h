...
+ (id)labelsForDevice:(id)arg1 withCount:(unsigned int)arg2 start:(unsigned int)arg3 multiple:(unsigned int)arg4 repeat:(unsigned int)arg5 font:(long long)arg6 modifier:(id)arg7 center:(struct CGPoint)arg8 radius:(double)arg9 paddedWithZeros:(BOOL)arg10 filter:(BOOL)arg11;
...
+ (void)updateNodes:(id)arg1 forDevice:(id)arg2 offset:(unsigned long long)arg3 center:(struct CGPoint)arg4 radius:(double)arg5 angleMultiplier:(double)arg6 scale:(double)arg7 rotate:(BOOL)arg8 round:(BOOL)arg9;
