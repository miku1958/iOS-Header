...
+ (id)labelsWithCount:(unsigned int)arg1 start:(unsigned int)arg2 multiple:(unsigned int)arg3 repeat:(unsigned int)arg4 font:(long long)arg5 fontSize:(double)arg6 center:(struct CGPoint)arg7 radius:(double)arg8 paddedWithZeros:(BOOL)arg9 filter:(BOOL)arg10;
...
+ (void)updateNodes:(id)arg1 offset:(unsigned long long)arg2 center:(struct CGPoint)arg3 radius:(double)arg4 angleMultiplier:(double)arg5 scale:(double)arg6 rotate:(BOOL)arg7 round:(BOOL)arg8;
