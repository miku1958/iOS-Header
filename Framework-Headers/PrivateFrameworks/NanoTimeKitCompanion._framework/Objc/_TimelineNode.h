...
@property (strong, nonatomic) _TimelineNode *leftNode; // @synthesize leftNode=_leftNode;
@property (readonly, nonatomic) _TimelineEntryNode *rightEntryNode;
@property (strong, nonatomic) _TimelineNode *rightNode; // @synthesize rightNode=_rightNode;
