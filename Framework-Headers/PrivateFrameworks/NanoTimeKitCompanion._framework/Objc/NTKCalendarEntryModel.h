...
@property (strong, nonatomic) NSString *primaryEventTitle; // @synthesize primaryEventTitle=_primaryEventTitle;
@property (strong, nonatomic) NSString *secondaryEventTitle; // @synthesize secondaryEventTitle=_secondaryEventTitle;
