...
- (void)remote_handleNotificationResponse:(ASUserNotificationResponse *)arg1 completion:(void (^)(BOOL, NSError *))arg2;
...
- (void)remote_queryAppBadgeCountWithCompletion:(void (^)(NSNumber *, BOOL, NSError *))arg1;
