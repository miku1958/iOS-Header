...
@property (strong, nonatomic) VUIMediaItemEntityTypesFetchResponse *currentFetchResponse; // @synthesize currentFetchResponse=_currentFetchResponse;
@property (nonatomic) long long fetchReason; // @synthesize fetchReason=_fetchReason;
@property (strong, nonatomic) VUIMediaItemEntityTypesFetchControllerResult *result; // @synthesize result=_result;
