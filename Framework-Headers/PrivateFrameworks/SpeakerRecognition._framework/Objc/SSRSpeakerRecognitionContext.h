...
@property (readonly, nonatomic) BOOL osTransactionReqd; // @synthesize osTransactionReqd=_osTransactionReqd;
...
@property (strong, nonatomic) NSArray *voiceProfileArray; // @synthesize voiceProfileArray=_voiceProfileArray;
