...
@property (readonly, weak) HMDCameraProfile *cameraProfile; // @synthesize cameraProfile=_cameraProfile;
...
@property (weak) id<HMDCameraBackingStoreDelegate> delegate; // @synthesize delegate=_delegate;
