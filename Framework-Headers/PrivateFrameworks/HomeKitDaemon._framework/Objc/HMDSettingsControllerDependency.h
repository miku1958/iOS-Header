...
@property (strong) id<HMDSettingsBackingStoreController> backingStoreController; // @synthesize backingStoreController=_backingStoreController;
@property (readonly) NSString *codingKey; // @synthesize codingKey=_codingKey;
@property (readonly, copy) NSString *debugDescription;
@property (readonly, copy) NSString *description;
@property (readonly) unsigned long long hash;
@property (strong) HMDSettingsMessageHandler<HMDSettingsMessageHandlerProtocol> *internalMessageHandler; // @synthesize internalMessageHandler=_internalMessageHandler;
