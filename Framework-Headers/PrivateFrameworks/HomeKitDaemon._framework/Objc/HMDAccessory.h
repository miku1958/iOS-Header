...
@property (strong, nonatomic) HAPTimer *systemTimeInformationTimer; // @synthesize systemTimeInformationTimer=_systemTimeInformationTimer;
...
@property (strong, nonatomic) HAPTimer *timeInformationTimer; // @synthesize timeInformationTimer=_timeInformationTimer;
...
- (void)configureWithAccessory:(id)arg1 reAddServices:(BOOL)arg2 queue:(id)arg3 completion:(CDUnknownBlockType)arg4;
