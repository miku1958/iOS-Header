...
@property (readonly, weak) id<HMDVideoStreamReconfigureDelegate> delegate; // @synthesize delegate=_delegate;
@property (readonly, nonatomic) NSObject<OS_dispatch_queue> *delegateQueue; // @synthesize delegateQueue=_delegateQueue;
@property (readonly, copy) NSString *description;
@property (strong, nonatomic) HMFTimer *downgradeDebouceTimer; // @synthesize downgradeDebouceTimer=_downgradeDebouceTimer;
@property (strong, nonatomic) NSDictionary *downlinkQualityInfo; // @synthesize downlinkQualityInfo=_downlinkQualityInfo;
