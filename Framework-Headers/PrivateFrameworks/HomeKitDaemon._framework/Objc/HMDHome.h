...
@property (strong, nonatomic) id<NSObject> WiFiAssertion; // @synthesize WiFiAssertion=_WiFiAssertion;
...
@property (getter=isActiveNetworkRouterInitialSetupNeeded) BOOL activeNetworkRouterInitialSetupNeeded; // @synthesize activeNetworkRouterInitialSetupNeeded=_activeNetworkRouterInitialSetupNeeded;
...
@property (strong, nonatomic) NSMutableArray *currentTriggers; // @synthesize currentTriggers=_currentTriggers;
...
@property (getter=isDoorbellChimeEnabled) BOOL doorbellChimeEnabled; // @synthesize doorbellChimeEnabled=_doorbellChimeEnabled;
...
@property (strong) HMDHomeNaturalLightingContextUpdater *naturalLightingContextUpdater; // @synthesize naturalLightingContextUpdater=_naturalLightingContextUpdater;
...
@property (strong) HMDHomePersonDataManager *personDataManager; // @synthesize personDataManager=_personDataManager;
...
- (void)_sendClientCharacteristicsChangedNotification:(id)arg1 identifier:(id)arg2 request:(id)arg3 entitledClientsOnly:(BOOL)arg4 multiPartResponse:(BOOL)arg5 moreMessagesInMultipart:(BOOL)arg6 withCompletionHandler:(CDUnknownBlockType)arg7;
