...
@property (strong, nonatomic) NSNumber *announceAccessAllowed; // @dynamic announceAccessAllowed;
@property (strong, nonatomic) NSNumber *announceAccessLevel; // @dynamic announceAccessLevel;
