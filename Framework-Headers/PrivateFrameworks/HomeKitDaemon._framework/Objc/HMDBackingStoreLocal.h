...
@property (strong, nonatomic) NSMutableDictionary *storeCache; // @synthesize storeCache=_storeCache;
@property (readonly) Class superclass;
@property (strong, nonatomic) NSMutableArray *zoneCache; // @synthesize zoneCache=_zoneCache;
