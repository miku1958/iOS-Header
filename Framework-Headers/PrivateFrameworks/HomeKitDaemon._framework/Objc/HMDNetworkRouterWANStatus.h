...
@property (strong, nonatomic) HAPTLVUnsignedNumberValue *identifier; // @synthesize identifier=_identifier;
@property (strong, nonatomic) HAPTLVUnsignedNumberValue *status; // @synthesize status=_status;
