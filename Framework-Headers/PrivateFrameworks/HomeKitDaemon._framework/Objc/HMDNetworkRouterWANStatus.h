...
@property (strong, nonatomic) HMDTLVUnsignedNumberValue *identifier; // @synthesize identifier=_identifier;
@property (strong, nonatomic) HMDTLVUnsignedNumberValue *status; // @synthesize status=_status;
