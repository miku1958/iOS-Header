...
@property (strong, nonatomic) NSMutableSet *configuredTargets; // @synthesize configuredTargets=_configuredTargets;
@property (readonly, weak, nonatomic) HMDHAPAccessory *controller; // @synthesize controller=_controller;
