...
@property (strong, nonatomic) CDXClient *cdxClient; // @synthesize cdxClient=_cdxClient;
@property (strong) NSMutableDictionary *cdxSessions; // @synthesize cdxSessions=_cdxSessions;
@property (strong) NSMutableDictionary *pidToConnectTimeoutSource; // @synthesize pidToConnectTimeoutSource=_pidToConnectTimeoutSource;
