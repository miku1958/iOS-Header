...
+ (id)imageWithSize:(struct CGSize)arg1 alpha:(BOOL)arg2 actions:(CDUnknownBlockType)arg3;
+ (id)imageWithSize:(struct CGSize)arg1 alpha:(BOOL)arg2 cgContextActions:(CDUnknownBlockType)arg3;
