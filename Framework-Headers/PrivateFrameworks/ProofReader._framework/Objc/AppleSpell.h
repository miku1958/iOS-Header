...
+ (id)sharedInstance;
- (id)_accentCorrectionResultForString:(id)arg1 range:(struct _NSRange)arg2 inString:(id)arg3 offset:(unsigned long long)arg4 language:(id)arg5 onlyAtInsertionPoint:(BOOL)arg6 capitalize:(BOOL)arg7 keyEventArray:(id)arg8 selectedRangeValue:(id)arg9;
- (BOOL)_acceptWithoutAccentForString:(id)arg1 range:(struct _NSRange)arg2 inString:(id)arg3 language:(id)arg4;
...
- (id)_stringForTokenIDs:(const unsigned int *)arg1 tokenCount:(unsigned long long)arg2 entryString:(id)arg3 languageModel:(id)arg4 language:(id)arg5 connection:(struct _PR_DB_IO *)arg6 sender:(id)arg7 encoding:(unsigned int)arg8 prefix:(id)arg9 capitalized:(BOOL)arg10;
...
- (char *)_validatedGuessWordBuffer:(char *)arg1 length:(unsigned long long)arg2 language:(id)arg3 connection:(struct _PR_DB_IO *)arg4 sender:(id)arg5 checkUser:(BOOL)arg6 additionalBuffer:(char *)arg7;
