...
- (BOOL)canMoveCheckedChecklistsToBottomInTextView:(struct UITextView *)arg1 forRange:(struct _NSRange)arg2;
- (BOOL)canMoveListItemInDirection:(unsigned long long)arg1 inTextView:(struct UITextView *)arg2 forRange:(struct _NSRange)arg3;
- (BOOL)checklistItemExistsMarkedCompleted:(BOOL)arg1 inTextView:(struct UITextView *)arg2 forRanges:(id)arg3;
...
- (void)indentRange:(struct _NSRange)arg1 byAmount:(long long)arg2 inTextStorage:(id)arg3 textView:(struct UITextView *)arg4 forceUpdateAttributes:(BOOL)arg5;
- (id)init;
...
- (void)markAllChecklistItemsCompleted:(BOOL)arg1 inTextview:(struct UITextView *)arg2 forSelectedRanges:(id)arg3;
- (BOOL)moveCheckedChecklistsToBottomInTextView:(struct UITextView *)arg1 forRange:(struct _NSRange)arg2;
- (BOOL)moveCheckedChecklistsToBottomInTextView:(struct ICTextView *)arg1 forRange:(struct _NSRange)arg2 animated:(BOOL)arg3;
- (BOOL)moveListItemInDirection:(unsigned long long)arg1 inTextView:(struct UITextView *)arg2 forRange:(struct _NSRange)arg3;
...
- (void)removeChecklistItemsMarkedCompleted:(BOOL)arg1 inTextView:(struct UITextView *)arg2 forRanges:(id)arg3;
