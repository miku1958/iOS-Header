...
@property (strong, nonatomic) NSArray *filteredFriendPlayers; // @synthesize filteredFriendPlayers=_filteredFriendPlayers;
@property (strong, nonatomic) NSArray *filteredRecentPlayers; // @synthesize filteredRecentPlayers=_filteredRecentPlayers;
...
@property (strong, nonatomic) NSMutableArray *selectedPlayersStack; // @synthesize selectedPlayersStack=_selectedPlayersStack;
