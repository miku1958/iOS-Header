...
@property (strong, nonatomic) id<TPPublicKey> encryptionPubKey; // @synthesize encryptionPubKey=_encryptionPubKey;
...
@property (strong, nonatomic) id<TPPublicKey> signingPubKey; // @synthesize signingPubKey=_signingPubKey;
