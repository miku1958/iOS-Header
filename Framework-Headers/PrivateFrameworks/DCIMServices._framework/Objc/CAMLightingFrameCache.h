...
@property (strong, nonatomic) NSDictionary *_backgroundFrameMapsByLightingType; // @synthesize _backgroundFrameMapsByLightingType=__backgroundFrameMapsByLightingType;
@property (strong, nonatomic) NSMutableDictionary *_foregroundFramesByAvailableAngle; // @synthesize _foregroundFramesByAvailableAngle=__foregroundFramesByAvailableAngle;
