...
@property (strong, nonatomic) NSArray *colorIndices; // @synthesize colorIndices=_colorIndices;
@property (strong, nonatomic) CAGradientLayer *gaugeLayer; // @synthesize gaugeLayer=_gaugeLayer;
...
@property (strong, nonatomic) CAShapeLayer *valueIndicatorLayer; // @synthesize valueIndicatorLayer=_valueIndicatorLayer;
