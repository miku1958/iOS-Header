...
@property (strong, nonatomic) FCFeedEdition *followingEdition; // @synthesize followingEdition=_followingEdition;
...
@property (strong, nonatomic) NSHashTable *insertedGroupsFromPage; // @synthesize insertedGroupsFromPage=_insertedGroupsFromPage;
