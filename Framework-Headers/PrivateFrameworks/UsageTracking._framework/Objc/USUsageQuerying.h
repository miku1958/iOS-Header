...
- (void)_enumerateCurrentApplicationUsageIntervalsDuringInterval:(id)arg1 referenceDate:(id)arg2 focalOnly:(BOOL)arg3 block:(CDUnknownBlockType)arg4;
- (void)_enumerateCurrentVideoUsageIntervalsDuringInterval:(id)arg1 referenceDate:(id)arg2 block:(CDUnknownBlockType)arg3;
- (void)_enumerateCurrentWebUsageIntervalsDuringInterval:(id)arg1 referenceDate:(id)arg2 focalOnly:(BOOL)arg3 block:(CDUnknownBlockType)arg4;
