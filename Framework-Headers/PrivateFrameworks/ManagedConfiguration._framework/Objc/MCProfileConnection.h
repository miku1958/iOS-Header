...
- (void)setBoolValue:(BOOL)arg1 ask:(BOOL)arg2 forSetting:(id)arg3 configurationUUID:(id)arg4 toSystem:(BOOL)arg5 user:(BOOL)arg6 passcode:(id)arg7 waitUntilCompleted:(BOOL)arg8 completion:(CDUnknownBlockType)arg9;
...
- (void)setParametersForSettingsByType:(id)arg1 configurationUUID:(id)arg2 toSystem:(BOOL)arg3 user:(BOOL)arg4 passcode:(id)arg5 waitUntilCompleted:(BOOL)arg6 completion:(CDUnknownBlockType)arg7;
