...
- (void)p_finishMetalRenderInContext:(struct CGContext *)arg1 orDirectly:(id)arg2 pathVertexData:(vector_8bba9095 *)arg3 parameterized:(BOOL)arg4 shouldReverseDrawOrder:(BOOL)arg5 withLayoutOptions:(id)arg6;
