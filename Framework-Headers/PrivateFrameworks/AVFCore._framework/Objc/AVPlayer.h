...
@property (strong, nonatomic, getter=_STSLabel, setter=_setSTSLabel:) NSString *STSLabel;
...
- (BOOL)_getDisplayVideoRange:(id *)arg1 displaySize:(struct CGSize *)arg2 refreshRate:(id *)arg3;
