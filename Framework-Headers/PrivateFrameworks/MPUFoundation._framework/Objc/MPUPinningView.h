...
@property (strong, nonatomic) CALayer *pinningSourceLayer; // @synthesize pinningSourceLayer=_pinningSourceLayer;
@property (strong, nonatomic) UIView *pinningSourceView; // @synthesize pinningSourceView=_pinningSourceView;
