...
@property (strong, nonatomic) MNActiveRouteInfo *alternateRoute; // @synthesize alternateRoute=_alternateRoute;
@property (nonatomic) CDStruct_3f2a7a20 divergenceCoordinate; // @synthesize divergenceCoordinate=_divergenceCoordinate;
@property (strong, nonatomic) MNActiveRouteInfo *mainRoute; // @synthesize mainRoute=_mainRoute;
