...
- (void)setFetchFilterWithAssets:(NSArray *)arg1 forApplication:(NSString *)arg2 withAuditToken:(CDStruct_4c969caf)arg3 completionHandler:(void (^)(BOOL, NSError *))arg4;
