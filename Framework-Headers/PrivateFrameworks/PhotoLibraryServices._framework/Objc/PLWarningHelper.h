...
@property (strong, nonatomic, setter=_setAdditionalPhotoStreamAssets:) NSArray *_additionalPhotoStreamAssets; // @synthesize _additionalPhotoStreamAssets=__additionalPhotoStreamAssets;
@property (strong, nonatomic, setter=_setAssets:) NSArray *_assets; // @synthesize _assets=__assets;
@property (strong, nonatomic, setter=_setClientName:) NSString *_clientName; // @synthesize _clientName=__clientName;
