...
+ (BOOL)_batchFetchedObjects:(id)arg1 inMOC:(id)arg2 batchSize:(unsigned long long)arg3 objectHandler:(CDUnknownBlockType)arg4 error:(id *)arg5;
...
+ (BOOL)_migrateForEachAsset:(CDUnknownBlockType)arg1 usingStore:(id)arg2;
