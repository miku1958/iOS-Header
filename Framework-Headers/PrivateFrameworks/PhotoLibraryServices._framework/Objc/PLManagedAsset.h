...
@property (strong, nonatomic) NSSet *cloudComments; // @dynamic cloudComments;
...
@property (readonly) unsigned long long hash;
@property (readonly) unsigned long long hash;
@property (strong, nonatomic) NSNumber *hdrGain; // @dynamic hdrGain;
...
@property (strong, nonatomic) NSSet *likeComments; // @dynamic likeComments;
@property (strong, nonatomic) NSSet *likeComments; // @dynamic likeComments;
...
@property (readonly, strong, nonatomic) NSOrderedSet *orderedCloudComments;
@property (readonly, strong, nonatomic) NSOrderedSet *orderedLikeComments;
...
- (id)assetsLibraryURL;
- (id)attemptCameraProcessingAdjustmentWithImageConversionClient:(id)arg1 videoConversionClient:(id)arg2 isOnDemand:(BOOL)arg3 completionHandler:(CDUnknownBlockType)arg4;
...
- (BOOL)becomePhotoIrisWithMediaGroupUUID:(id)arg1 mainFileMetadata:(id)arg2 videoURL:(id)arg3 spatialOverCaptureURL:(id)arg4 videoDuration:(CDStruct_198678f7)arg5 stillDisplayTime:(CDStruct_198678f7)arg6 options:(unsigned long long)arg7;
- (BOOL)becomePhotoIrisWithMediaGroupUUID:(id)arg1 mainFileMetadata:(id)arg2 videoURL:(id)arg3 videoDuration:(CDStruct_198678f7)arg4 stillDisplayTime:(CDStruct_198678f7)arg5 options:(unsigned long long)arg6;
