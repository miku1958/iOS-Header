...
@property (weak, nonatomic) VideosExtrasVideoTimelineEvent *next; // @synthesize next=_next;
@property (readonly, nonatomic) double offset; // @synthesize offset=_offset;
@property (readonly, weak, nonatomic) VideosExtrasVideoTimelineEvent *previous; // @synthesize previous=_previous;
