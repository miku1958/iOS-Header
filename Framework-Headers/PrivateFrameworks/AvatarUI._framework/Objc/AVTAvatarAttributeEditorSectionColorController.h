...
+ (BOOL)updateCollectionViewLayout:(id)arg1 containerSize:(struct CGSize)arg2 environment:(id)arg3 forExtended:(BOOL)arg4 withSlider:(BOOL)arg5 numberOfItems:(long long)arg6;
- (void).cxx_destruct;
