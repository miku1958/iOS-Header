...
- (id)initWithCellSize:(struct CGSize)arg1 engagedCellSize:(struct CGSize)arg2 interitemSpacing:(double)arg3 gridEdgeInsets:(struct UIEdgeInsets)arg4 centerVertically:(BOOL)arg5;
