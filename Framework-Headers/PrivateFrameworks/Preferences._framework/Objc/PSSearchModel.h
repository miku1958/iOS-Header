...
@property (strong) PSSearchOperation *activeSearchOperation; // @synthesize activeSearchOperation=_activeSearchOperation;
...
@property (weak, nonatomic) id<PSSearchModelDataSource> dataSource; // @synthesize dataSource=_dataSource;
