...
@property (weak, nonatomic) MDIndexAgent *agent; // @synthesize agent=_agent;
...
@property (strong, nonatomic) NSSet *tccAllowances; // @synthesize tccAllowances=_tccAllowances;
