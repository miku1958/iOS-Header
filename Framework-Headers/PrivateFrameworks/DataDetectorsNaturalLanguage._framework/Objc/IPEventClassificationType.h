...
@property (strong, nonatomic) NSMutableArray *genericPatternKeywords; // @synthesize genericPatternKeywords=_genericPatternKeywords;
...
@property (strong, nonatomic) NSMutableArray *patternKeywords; // @synthesize patternKeywords=_patternKeywords;
...
@property (strong, nonatomic) NSMutableArray *subjectKeywords; // @synthesize subjectKeywords=_subjectKeywords;
@property (strong, nonatomic) NSMutableArray *titleKeywords; // @synthesize titleKeywords=_titleKeywords;
@property (strong, nonatomic) NSString *titleSenderTemplate; // @synthesize titleSenderTemplate=_titleSenderTemplate;
@property (strong, nonatomic) NSMutableDictionary *upperPriorityEventTypesIdentifiers; // @synthesize upperPriorityEventTypesIdentifiers=_upperPriorityEventTypesIdentifiers;
