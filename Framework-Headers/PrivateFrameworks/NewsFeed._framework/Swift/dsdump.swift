 ...
 protocol NewsFeed.FeedItemType // 4 requirements
 {
	// class base protocol
	// class base protocol
	// getter
 ...
 protocol NewsFeed.FeedGroupRepresentable // 5 requirements
 {
	// class base protocol
	// getter
	// getter
 ...
 protocol NewsFeed.ThumbnailImageLayoutAttributesType // 3 requirements
 {
	// getter
	// getter
	// getter
 ...
 protocol NewsFeed.ImageHeadlineViewStylerType // 13 requirements
 {
	// class base protocol
	// class base protocol
	// class base protocol
 ...
 protocol NewsFeed.ImageHeadlineViewRendererType // 2 requirements
 {
	// class base protocol
	// method
 }
 ...
 protocol NewsFeed.FeedGroupDescribing // 2 requirements
 {
	// getter
	// getter
 }
 ...
 protocol NewsFeed.FeedItemRendererType // 3 requirements
 {
	// class base protocol
	// method
	// method
 }
 protocol NewsFeed.DebugViewLayoutViewFactoryType // 1 requirements
 {
	// method
 }
 ...
 protocol NewsFeed.FeedItemSupplementaryRendererType // 3 requirements
 {
	// class base protocol
	// method
	// method
 ...
 struct NewsFeed.Attributes {
	...
	// Properties
	let frame : CGRect // +0x0
	let headlineLayoutAttributes : [ImageHeadlineViewLayout.Attributes] // +0x20
 }
 ...
 struct NewsFeed.Layout {
	...
	let headlineLayoutAttributes : LayoutItemList<ImageHeadlineViewLayout.Attributes> // +0x8
 }
 ...
 struct NewsFeed.FeedHeadline {
	...
	var headline : FCHeadlineProviding // +0x28
	var metadata : Swift.AnyObject? // +0x30
 ...
 struct NewsFeed.Attributes {
	...
	let headlineLayoutAttributes : [ImageHeadlineViewLayout.Attributes] // +0x130
 ...
 struct NewsFeed.Layout {
	...
	let headlineLayoutAttributes : LayoutItemList<ImageHeadlineViewLayout.Attributes> // +0x18
 ...
 struct NewsFeed.DebugViewSection {

	// Properties
	let title : String? // +0x0
	let footer : String? // +0x10
	let items : [DebugViewItem] // +0x20
 }
 ...
 struct NewsFeed.Layout {
	...
	// Properties
	let frame : LayoutItem<CGRect> // +0x0
	let headlineLayoutAttributes : LayoutItem<ImageHeadlineViewLayout.Attributes> // +0x8
 }
 ...
 struct NewsFeed.GroupLayoutBindingContext {
	...
	var bindings : [String : [FeedItemType]] // +0x30
 }

 enum NewsFeed.Errors {

	// Properties
	case notEnoughItemsMatching : (type: String, traits: FeedItemTraits, required: Int)
 }
 ...
 struct NewsFeed.FeedLayoutSolverOptions {
	...
	let coverOptions : CoverOptions // +0x2
 ...
 class NewsFeed.DebugViewDataSource : _SwiftObject /usr/lib/swift/libswiftCore.dylib {
	...
	let key : DebugViewLayoutKey // +0x0 (0x0)
	var sections : [DebugViewSection] // +0x3 (0x8)
 ...
 struct NewsFeed.FeaturedHeadlineViewLayout {
	...
	let thumbnailImageViewFrame : LayoutItem<CGRect> // +0x40
	let thumbnailImageRoundedCorners : LayoutItem<UIRectCorner> // +0x48
	let thumbnailImageRoundedCornerRadius : LayoutItem<CGFloat> // +0x50
 ...
 struct NewsFeed.Attributes {
	...
	let thumbnailImageViewFrame : CGRect // +0x108
	let thumbnailImageRoundedCorners : UIRectCorner // +0x128
	let thumbnailImageRoundedCornerRadius : CGFloat // +0x130
 ...
 enum NewsFeed.CodingKeys {
	...
	case thumbnailImageViewFrame  
	case thumbnailImageRoundedCorners  
	case thumbnailImageRoundedCornerRadius  
 ...
 struct NewsFeed.FeaturedIssueHeadlineViewLayout {
	...
	let thumbnailImageViewFrame : LayoutItem<CGRect> // +0x30
	...
	let thumbnailImageRoundedCorners : LayoutItem<UIRectCorner> // +0x50
	let thumbnailImageRoundedCornerRadius : LayoutItem<CGFloat> // +0x58
	let numberOfSegmentedColors : LayoutItem<Int> // +0x60
	let segmentedColorViewFrame : LayoutItem<CGRect> // +0x68
	let segmentedColorViewDirection : LayoutItem<SegmentedColorViewDirection> // +0x70
	let segmentedColorViewCorner : LayoutItem<UIRectCorner> // +0x78
 ...
 struct NewsFeed.Attributes {
	...
	let thumbnailImageViewFrame : CGRect // +0x130
	let thumbnailImageRoundedCorners : UIRectCorner // +0x150
	let thumbnailImageRoundedCornerRadius : CGFloat // +0x158
 ...
 enum NewsFeed.DebugViewItem {
	...
	case requirement : (String, match: DebugViewItem.RequirementMatch)
	case feedItem : FeedItemType
	case layoutFactory : (GroupLayoutFactoryType, match: DebugViewItem.GroupLayoutFactoryMatch)
 }
 ...
 class NewsFeed.FeaturedHeadlineViewStyler : _SwiftObject /usr/lib/swift/libswiftCore.dylib, FeaturedHeadlineViewStylerType {
	...
	// Properties
	let fontBook : HeadlineFontBook // +0x10 (0x20)
 ...
 class NewsFeed.DebugViewLayoutView : UIView /System/Library/Frameworks/UIKit.framework/UIKit {
 ...
 struct NewsFeed.FeedIssueHeadline {
	...
	let feedHeadline : FeedHeadline // +0xa8
 }
 ...
 enum NewsFeed.FeedItemRendererResult {
	...
	case imageHeadlineViewCell : CollectionViewCell<ImageHeadlineView>
 ...
 class NewsFeed.ImageHeadlineViewStyler : _SwiftObject /usr/lib/swift/libswiftCore.dylib, ImageHeadlineViewStylerType {
	...
	// Properties
	let fontBook : HeadlineFontBook // +0x10 (0x20)
	let colorPalette : HeadlineColorPalette // +0x30 (0x38)
	let scaleFactor : CGFloat // +0x68 (0x8)
	let colorPaletteProvider : ColorPaletteProviding // +0x70 (0x28)
 ...
 struct NewsFeed.ImageHeadlineViewLayout {
	...
	let thumbnailImageViewFrame : LayoutItem<CGRect> // +0x30
	let thumbnailImageRoundedCorners : LayoutItem<UIRectCorner> // +0x38
	let thumbnailImageRoundedCornerRadius : LayoutItem<CGFloat> // +0x40
 ...
 struct NewsFeed.Attributes {
	...
	let thumbnailImageViewFrame : CGRect // +0xa8
	let thumbnailImageRoundedCorners : UIRectCorner // +0xc8
	let thumbnailImageRoundedCornerRadius : CGFloat // +0xd0
	let publisherLogoImageViewFrame : CGRect // +0xd8
 }
 ...
 struct NewsFeed.Context {
	...
	let key : GroupLayoutKey
	let model : FeedHeadline
	let styler : ImageHeadlineViewStylerType
	let cachedTitleText : CachedText<NSAttributedString>
	let cachedExcerptText : CachedText<NSAttributedString>?
	let cachedPublisherText : CachedText<NSAttributedString>
	let cachedPublishedDateText : CachedText<NSAttributedString>
 ...
 class NewsFeed.DebugViewController : UIViewController /System/Library/Frameworks/UIKit.framework/UIKit {
	...
	// Properties
	let key : DebugViewLayoutKey // +0x0 (0x0)
	let result : DebugViewResult // +0x0 (0x61)
	let factory : DebugViewLayoutViewFactoryType // +0x0 (0x28)
	let dataSource : DebugViewDataSource // +0x0 (0x8)
 ...
 class NewsFeed.ImageHeadlineViewRenderer : _SwiftObject /usr/lib/swift/libswiftCore.dylib, ImageHeadlineViewRendererType {
 ...
 struct NewsFeed.Context {
	...
	let styler : GapOfflineViewStylerType // +0x48
	let cachedOfflineText : CachedText<NSAttributedString> // +0x70
 }
 ...
 struct NewsFeed.DebugViewLayoutKey {
 ...
 struct NewsFeed.FeedLayoutCacheItem {
	...
	let feedItemLayoutAttributes : [FeedItemLayoutAttributes] // +0x28
 }
 ...
 struct NewsFeed.FeedGroupRegion {
	...
	let feedGroupKind : FeedGroupKind // +0x28
	let feedGroupContextIdentifier : String // +0x30
 }
 ...
 enum NewsFeed.FeedItemLayoutAttributes {
	...
	case imageHeadlineView : (ImageHeadlineViewLayout.Context, ImageHeadlineViewLayout.Attributes, visualRank: Int)
 ...
 class NewsFeed.FeedItemRenderer : _SwiftObject /usr/lib/swift/libswiftCore.dylib, FeedItemRendererType {
	...
	let imageHeadlineViewRenderer : ImageHeadlineViewRendererType // +0x38 (0x10)
 ...
 class NewsFeed.DebugViewLayoutViewFactory : _SwiftObject /usr/lib/swift/libswiftCore.dylib, DebugViewLayoutViewFactoryType {

	// Properties
	let colorPaletteProvider : ColorPaletteProviding // +0x10 (0x28)
	var imageHeadlineViewRenderer : weak ImageHeadlineViewRendererType? // +0x38 (0x10)
 ...
 class NewsFeed.FeedItemRendererTool : _SwiftObject /usr/lib/swift/libswiftCore.dylib {
	...
	let debugViewLayoutViewFactory : DebugViewLayoutViewFactoryType // +0x38 (0x28)
	var debugEnabled : Bool // +0x60 (0x1)
	var debugColors : FeedItemDebugColors // +0x68 (0x8)
	var shineImageFactory : ShineImageFactory // +0x70 (0x8)
 ...
 class NewsFeed.FeedItemSupplementaryRenderer : _SwiftObject /usr/lib/swift/libswiftCore.dylib, FeedItemSupplementaryRendererType {
	...
	// Properties
	var colorPaletteProvider : ColorPaletteProviding // +0x10 (0x28)
	var featuredIssueSupplementaryViewRenderer : FeaturedIssueSupplementViewRendererType // +0x38 (0x10)
