...
- (void)getTextureAccessCounters:(id<MTLTexture>)arg1 region:(CDStruct_1e3be3a8)arg2 mipLevel:(unsigned long long)arg3 slice:(unsigned long long)arg4 resetCounters:(BOOL)arg5 countersBuffer:(id<MTLBuffer>)arg6 countersBufferOffset:(unsigned long long)arg7;
