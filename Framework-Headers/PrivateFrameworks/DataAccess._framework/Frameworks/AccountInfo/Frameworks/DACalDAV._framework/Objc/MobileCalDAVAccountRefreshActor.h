...
@property (strong, nonatomic) NSArray *attachmentUUIDsToUpload; // @synthesize attachmentUUIDsToUpload=_attachmentUUIDsToUpload;
...
@property (nonatomic) BOOL refreshFoundDeletedContainerURL; // @synthesize refreshFoundDeletedContainerURL=_refreshFoundDeletedContainerURL;
@property (nonatomic) BOOL refreshFoundUpdatedSpecialCalendar; // @synthesize refreshFoundUpdatedSpecialCalendar=_refreshFoundUpdatedSpecialCalendar;
@property (nonatomic) BOOL refreshFoundUpdatedTaskContainer; // @synthesize refreshFoundUpdatedTaskContainer=_refreshFoundUpdatedTaskContainer;
