...
@property (strong, nonatomic) NSSet *addedCalendars; // @synthesize addedCalendars=_addedCalendars;
@property (strong, nonatomic) AKAppleIDSession *appleIDSession; // @synthesize appleIDSession=_appleIDSession;
@property (strong, nonatomic) NSArray *calendarChangesToClear; // @synthesize calendarChangesToClear=_calendarChangesToClear;
...
@property (strong, nonatomic) NSSet *modifiedCalendars; // @synthesize modifiedCalendars=_modifiedCalendars;
