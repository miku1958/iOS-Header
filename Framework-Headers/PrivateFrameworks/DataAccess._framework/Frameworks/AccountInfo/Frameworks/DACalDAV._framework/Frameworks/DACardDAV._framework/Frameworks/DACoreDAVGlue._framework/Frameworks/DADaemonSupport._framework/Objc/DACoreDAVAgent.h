...
@property (strong, nonatomic) CoreDAVOptionsTask *optionsProbe; // @synthesize optionsProbe=_optionsProbe;
@property (strong, nonatomic) NSTimer *optionsTimeoutTimer; // @synthesize optionsTimeoutTimer=_optionsTimeoutTimer;
