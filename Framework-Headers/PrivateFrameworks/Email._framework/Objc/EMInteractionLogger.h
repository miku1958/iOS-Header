...
@property (strong, nonatomic) NSMutableDictionary *messageListMessages; // @synthesize messageListMessages=_messageListMessages;
@property (nonatomic) struct _NSRange messageListVisibleRows; // @synthesize messageListVisibleRows=_messageListVisibleRows;
@property (strong, nonatomic) NSObject<OS_dispatch_queue> *stateTrackingQueue; // @synthesize stateTrackingQueue=_stateTrackingQueue;
@property (readonly) Class superclass;
@property (strong, nonatomic) NSMutableDictionary *viewedMessages; // @synthesize viewedMessages=_viewedMessages;
