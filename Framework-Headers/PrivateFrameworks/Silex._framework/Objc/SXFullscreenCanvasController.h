...
@property (strong, nonatomic) SXFullscreenNavigationBarView *navigationBarView; // @synthesize navigationBarView=_navigationBarView;
...
@property (readonly, weak, nonatomic) id<SXFullscreenCanvasShowable> showable; // @synthesize showable=_showable;
