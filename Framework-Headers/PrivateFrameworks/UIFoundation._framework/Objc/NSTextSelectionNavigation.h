...
@property BOOL allowsNonContiguousRanges; // @synthesize allowsNonContiguousRanges=_allowsNonContiguousRanges;
@property BOOL rotatesCoordinateSystemForLayoutOrientation; // @synthesize rotatesCoordinateSystemForLayoutOrientation=_rotatesCoordinateSystemForLayoutOrientation;
@property (weak) id<NSTextSelectionDataSource> textSelectionDataSource; // @synthesize textSelectionDataSource=_textSelectionDataSource;
...
- (id)_lineFragmentInfoForPoint:(struct CGPoint)arg1 inContainerAtLocation:(id)arg2 bounds:(struct CGRect)arg3 layoutOrientation:(long long)arg4 beforeDocument:(out BOOL *)arg5 afterDocument:(out BOOL *)arg6 lineFragmentRange:(out id *)arg7;
...
- (id)textSelectionsForPoint:(struct CGPoint)arg1 inContainerAtLocation:(id)arg2 anchors:(id)arg3 modifiers:(unsigned long long)arg4 selecting:(BOOL)arg5;
- (id)textSelectionsInteractingAtPoint:(struct CGPoint)arg1 inContainerAtLocation:(id)arg2 anchors:(id)arg3 modifiers:(unsigned long long)arg4 selecting:(BOOL)arg5;
- (id)textSelectionsInteractingAtPoint:(struct CGPoint)arg1 inContainerAtLocation:(id)arg2 anchors:(id)arg3 modifiers:(unsigned long long)arg4 selecting:(BOOL)arg5 bounds:(struct CGRect)arg6;
