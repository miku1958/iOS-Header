...
@property (strong, nonatomic) TAInterVisitMetricsSnapshot *interVisitMetricsSnapshotBackup; // @synthesize interVisitMetricsSnapshotBackup=_interVisitMetricsSnapshotBackup;
@property (strong, nonatomic) NSHashTable *observers; // @synthesize observers=_observers;
@property (strong, nonatomic) TAScanRequest *scanRequest; // @synthesize scanRequest=_scanRequest;
@property (strong, nonatomic) TAVisitStateSettings *settings; // @synthesize settings=_settings;
