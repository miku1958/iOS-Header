...
@property (strong, nonatomic) NSString *choiceIdentifier; // @synthesize choiceIdentifier=_choiceIdentifier;
@property (weak, nonatomic) id<PTChoiceRowDataSource> dataSource; // @synthesize dataSource=_dataSource;
