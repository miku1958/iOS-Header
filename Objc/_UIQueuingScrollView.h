...
@property (weak, nonatomic) id<_UIQueuingScrollViewDataSource> qDataSource; // @synthesize qDataSource=_qDataSource;
@property (weak, nonatomic) id<_UIQueuingScrollViewDelegate> qDelegate; // @synthesize qDelegate=_qDelegate;
