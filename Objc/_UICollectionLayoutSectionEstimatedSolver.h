...
@property (strong, nonatomic) _UICollectionLayoutAuxillaryItemSolver *sectionSupplementarySolution; // @synthesize sectionSupplementarySolution=_sectionSupplementarySolution;
...
@property (strong, nonatomic) _UICollectionLayoutSolutionState *solutionState; // @synthesize solutionState=_solutionState;
