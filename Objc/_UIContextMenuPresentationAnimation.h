...
@property (weak, nonatomic) id<_UIContextMenuPresentationAnimationDelegate> delegate; // @synthesize delegate=_delegate;
...
@property (strong, nonatomic) _UIContextMenuReparentingContainerView *reparentingContainerView; // @synthesize reparentingContainerView=_reparentingContainerView;
