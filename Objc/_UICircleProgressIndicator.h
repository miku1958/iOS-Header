...
@property (strong, nonatomic) UIImage *borderImage; // @synthesize borderImage=_borderImage;
@property (strong, nonatomic) UIImage *fillImage; // @synthesize fillImage=_fillImage;
