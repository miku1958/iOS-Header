...
@property (strong, nonatomic, setter=_setAccessibilityLimits:) _UIAccessibilityLimits *_accessibilityLimits;
...
- (struct CGRect)_boundsForSceneDraggingConstrainedToSafeArea:(BOOL)arg1;
