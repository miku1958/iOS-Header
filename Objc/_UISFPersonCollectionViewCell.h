...
@property (strong, nonatomic) _UICircleProgressView *circleProgressView; // @synthesize circleProgressView=_circleProgressView;
@property (nonatomic) BOOL darkStyleOnLegacyApp; // @synthesize darkStyleOnLegacyApp=_darkStyleOnLegacyApp;
@property (weak, nonatomic) NSObject<_UISFPersonCollectionViewCellDelegate> *delegate; // @synthesize delegate=_delegate;
@property (strong, nonatomic) UIColor *fadedSecondLabelColor; // @synthesize fadedSecondLabelColor=_fadedSecondLabelColor;
@property (strong, nonatomic) _UISFPersonImageView *imageView; // @synthesize imageView=_imageView;
