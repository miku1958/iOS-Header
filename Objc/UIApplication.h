...
@property (nonatomic, getter=_isCurrentActivityContinuationDisplayingUI, setter=_setCurrentActivityContinuationProgressDisplayingUI:) BOOL currentActivityContinuationProgressDisplayingUI; // @synthesize currentActivityContinuationProgressDisplayingUI=_currentActivityContinuationProgressDisplayingUI;
...
- (void)_handleApplicationDeactivationWithScene:(id)arg1 shouldForceExit:(BOOL)arg2 transitionContext:(id)arg3 completion:(CDUnknownBlockType)arg4;
