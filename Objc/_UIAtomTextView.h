...
@property (weak, nonatomic) id<_UIAtomTextViewDelegate> delegate; // @synthesize delegate=_delegate;
...
@property (weak, nonatomic) id<UITextInputDelegate> inputDelegate; // @dynamic inputDelegate;
